...
class M_InventarisGereja extends Model
{
    ...
    protected $allowedFields = [
        'kode_aset', 'nama_aset', 'id_kategori', 'id_lokasi', 'merk', 'model', 
        'serial_number', 'tahun_pembuatan', 'tanggal_pembelian', 'harga_perolehan', 
        'nilai_residu', 'masa_pakai', 'metode_depreciation', 'nilai_buku', 
        'akumulasi_depreciation', 'supplier', 'no_faktur', 'warranty_start', 
        'warranty_end', 'insurance_company', 'insurance_policy', 'insurance_value', 
        'kondisi', 'status', 'qr_code', 'barcode', 'foto_aset', 'spesifikasi', 
    ...
    public function getStatistik()
    {
        ...
        $rusak = $this->where('status', 'Rusak')->countAllResults(false);
        ...
        return [
            ...
            'aset_rusak' => $rusak,
            'total_nilai_perolehan' => $totalNilai['harga_perolehan'] ?? 0,
            'total_akumulasi_depreciation' => $totalDepreciasi['akumulasi_depreciation'] ?? 0,
            'total_nilai_buku' => $totalNilaiBuku['nilai_buku'] ?? 0
        ];
    }
    ...
    {
        if (empty($serial_number)) return false;
