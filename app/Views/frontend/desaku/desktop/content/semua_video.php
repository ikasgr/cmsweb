                ...
                <div class="article-detail mb-0">
                                    ...
                                    <div class="single-blog-post style-4 mb-30">
                                        <div class="newsthumb videothumb mb-3">
                                            <div class="newsthumb__img">
                                                <a href="https://www.youtube.com/embed/<?= esc($data['video_link']) ?>" target="_blank"><iframe width="100%" height="200" class="embed-responsive-item" src="https://www.youtube.com/embed/<?= esc($data['video_link']) ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen alt="img"></iframe></a>
                                            </div>
                                            <div class="newsthumb__content">
                                                <div class="catedate">
                                                    <!-- <span class="date"><?= date_indo($data['tanggal']) ?></span> -->
                                                    <a class="newsthumb__title"><a href="https://www.youtube.com/embed/<?= esc($data['video_link']) ?>" target="_blank"><?= esc($data['judul']) ?></a></a>
                                                </div>
                                                <hr>
                                            </div>
                                        </div>
                    ...
                    <?php } else { ?>
                        <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                            <a target='_BLANK' style='color:red'>Belum ada data Video..!</a><br> Punya pertanyaan, keluhan, masukan atau saran, silahkan klik <b class="tambahkritik pointer">disini</b>, untuk sampaikan.
                        </div>
                    <?php } ?>
