                ...
                <div class="blog-comments mt-1">
                                ...
                                ?>
                                    <div class="alert" style='background-color:#f8f9f4; border-color:#e3e3e3;'>
                                        <div class="comment-img">
                                            <img class="img-circle comment-img float-left" src="<?= base_url('public/template/backend/img/usr2.png') ?>" width="60" alt="Nama">
                                        </div>
                                        <div>
                                        ...
                                        <div class="comment-img">
                                            <img class="comment-img float-left" src="<?= base_url('public/template/backend/img/adm.png') ?>" width="90" alt="Admin">
                                        </div>
                                        <!-- <div> -->
                    ...
                    <?php } else { ?>
                        <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                            <a style='color:light'>Belum Ada data masukan saran.!</a><br> Punya pertanyaan, keluhan, masukan atau saran, silahkan <b>isi form dibawah</b>, untuk sampaikan.
                        </div>
                    <?php } ?>
                    ...
                    <div class="alert" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                        <img style='float:left; padding: 8px; margin-top:-13px; margin-right:5px;' width="80" class="pull-left" src="<?= base_url('public/template/backend/img/icon_rules.png') ?>">
                    ...
                    <div class="text-left ">
                        ...
                        <textarea type="text" id="isi_kritik" name="isi_kritik" class="form-control" placeholder="Tulis pertanyaan, keluhan, masukan atau saran anda disini*" required=""><?= htmlentities(set_value('isi_kritik'), ENT_QUOTES) ?></textarea>
