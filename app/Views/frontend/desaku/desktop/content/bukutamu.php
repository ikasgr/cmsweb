                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Nama</td>
                                        <td>
                                            <input type="text" id="nama" name="nama" value="<?= htmlentities(set_value('nama'), ENT_QUOTES) ?>" class="form-control" required>
                                    ...
                                    <tr>
                                        <td>No Hp</td>
                                        <td>
                                            <input type="text" id="telp" name="telp" class="form-control" value="<?= htmlentities(set_value('telp'), ENT_QUOTES) ?>" required>
                                    ...
                                    <tr>
                                        <td>Instansi</td>
                                        <td>
                                            <input type="text" id="instansi" name="instansi" value="<?= htmlentities(set_value('instansi'), ENT_QUOTES) ?>" class="form-control" required>
                                        ...
                                        <td>
                                            ...
                                            <select class="form-control" name="bidang_id" id="bidang_id" required>
                                                ...
                                                <?php foreach ($mbidang as $key => $data) { ?>
                                                    <option value="<?= $data['bidang_id'] ?>"><?= esc($data['nama_bidang']) ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <tr>
                                        <td>Keperluan</td>
                                        <td>
                                            <textarea type="text" id="keperluan" name="keperluan" class="form-control " required><?= htmlentities(set_value('keperluan'), ENT_QUOTES) ?></textarea>
