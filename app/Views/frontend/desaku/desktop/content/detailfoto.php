        ...
        <div class="row article-container pb-5">
            ...
            <div class="col-md-12 px-md-5">
                <div class="article-detail mb-0">
                    ...
                    <h1 class="text-blue montserrat-700 f-30 text-center">Galeri <?= esc($data['nama_kategori_foto']) ?> </h1>
                    <hr>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="single-blog-post style-4 mb-30">
                                        <div class="newsthumb fotothumb mb-4">
                                            ...
                                            <a class="gallery-popup" href="<?= base_url('/public/img/galeri/foto/' . esc($data['gambar'])) ?>" title="<?= esc($data['judul']) ?>">
                                                <img class="embed-responsive embed-responsive-16by9 wrapper-img-new" src="<?= base_url('/public/img/galeri/foto/thumb/' . 'thumb_'  . esc($data['gambar'])) ?>" alt="1" />
                                            </a>
                    ...
                    <?php } else { ?>
                        <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                            <a target='_BLANK' style='color:red'>Maaf tidak ditemukan Foto..!</a><br> Punya pertanyaan, keluhan, masukan atau saran, silahkan klik <b class="tambahkritik pointer">disini</b>, untuk sampaikan.
                        </div>
                    <?php } ?>
