    ...
    <div class="row">
        <div class="col">
            <h4 class="f-20 montserrat-700 text-light-blue">
                Hasil Pencarian: "<?= isset($keyword) ? esc($keyword) : '' ?>"
            </h4>
            ...
            <div class="col-md-9">
                        ...
                        <form action="<?= base_url('toko/search') ?>" method="get">
                            <div class="input-group">
                                <input type="text" name="q" class="form-control" placeholder="Cari produk..." 
                                       value="<?= isset($keyword) ? esc($keyword) : '' ?>" required>
                ...
                <?php if (isset($produk) && $produk) : ?>
                    <div class="alert alert-success">
                        ...
                        Ditemukan <strong><?= isset($total) ? $total : count($produk) ?></strong> produk untuk kata kunci "<strong><?= isset($keyword) ? esc($keyword) : '' ?></strong>"
                    </div>
                ...
                <?php else : ?>
                    <div class="alert alert-warning">
                        ...
                        Tidak ada produk yang ditemukan untuk kata kunci "<strong><?= isset($keyword) ? esc($keyword) : '' ?></strong>".
                    </div>
                    <div class="text-center mt-4">
                        <a href="<?= base_url('toko') ?>" class="btn btn-primary">
