                            ...
                            <?php foreach ($kategori_list as $kat) : ?>
                                <a href="<?= base_url('toko/kategori/' . $kat['slug_kategori']) ?>" 
                                   class="list-group-item list-group-item-action <?= (isset($kategori_slug) && $kategori_slug == $kat['slug_kategori']) ? 'active' : '' ?>">
                                    ...
                                    <span class="badge badge-<?= (isset($kategori_slug) && $kategori_slug == $kat['slug_kategori']) ? 'light' : 'primary' ?> badge-pill float-right">
                                        <?= $kat['jml_produk'] ?>
                                    </span>
                                </a>
                            <?php endforeach; ?>
            ...
            <div class="col-md-9">
                ...
                <?php if (isset($produk) && $produk) : ?>
                    <div class="alert alert-info">
                        ...
                        Menampilkan <strong><?= count($produk) ?></strong> produk dalam kategori <strong><?= isset($kategori_nama) ? esc($kategori_nama) : '' ?></strong>
                    </div>
