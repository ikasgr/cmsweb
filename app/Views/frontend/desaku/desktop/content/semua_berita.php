            ...
            <div class="col-md-1">
                <div class="share-button d-none d-sm-block position-sticky sticky-top">
                    ...
                    <ul>
                        ...
                        <li class="mb-4"><a target="_blank" href="https://twitter.com/intent/tweet?text=<?= base_url('berita/') ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/share-tw.png') ?>" /></a></li>
                        <li class="mb-4"><a target="_blank" href="https://web.whatsapp.com/send?text=<?= base_url('berita/') ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/wa.png') ?>" /></a></li>
                    </ul>
                </div>
                <div class="share-button d-sm-none">
                    ...
                    <ul>
                        ...
                        <li class="mb-4 mr-2 float-left"><a target="_blank" href="https://twitter.com/intent/tweet?text=<?= base_url('berita/') ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/share-tw.png') ?>" /></a></li>
                        <li class="mb-4 mr-2 float-left"><a target="_blank" href="https://web.whatsapp.com/send?text=<?= base_url('berita/') ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/wa.png') ?>" /></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-11 px-md-5">
                <div class="article-detail mb-0">
                    <h1 class="text-blue montserrat-700 f-30 text-center">Indeks Berita </h1>
                    <hr>
                    ...
                    <div class=" stretch-card grid-margin">
                        ...
                        <?php } else { ?>
                            <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                                <a style='color:red'>Belum ada data berita..!</a>
                            </div>
                        <?php } ?>
