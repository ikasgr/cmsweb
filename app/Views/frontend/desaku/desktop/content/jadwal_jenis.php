        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('jadwal/jenis/' . (isset($jenis_nama) ? urlencode($jenis_nama) : '')) ?>" method="get">
            ...
            <div class="col-md-9">
                ...
                <?php if (isset($jadwal) && $jadwal) : ?>
                    <div class="alert alert-info">
                        ...
                        Menampilkan <strong><?= count($jadwal) ?></strong> jadwal untuk <strong><?= isset($jenis_nama) ? esc($jenis_nama) : 'semua jenis' ?></strong>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-3 text-center border-right">
                                                <div class="date-box">
                                                    <h2 class="text-primary mb-0"><?= date('d', strtotime($item['tanggal'])) ?></h2>
                                                    <small class="text-muted"><?= strftime('%b', strtotime($item['tanggal'])) ?></small>
                                                </div>
                                            </div>
                                            <div class="col-9">
