                ...
                <div class="article-detail mb-0">
                    ...
                    <?php if ($layanan) { ?>
                        ...
                        <div class="alert alert-info" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                            Anda Punya pertanyaan, masukan atau saran, seputar layanan kami? Klik <b class="pointer" onclick="window.location.href='<?= base_url('masukansaran') ?>'">disini</b>, untuk sampaikan.
                        </div>
                        ...
                        ?>
                            ...
                            <div class="list-group mt-2">
                                <div class="list-group-item list-group-item-action " onclick="lihatlayanan('<?= $data['informasi_id'] ?>')">
                                    <div class="row no-gutters pointer">
                                        <div class="media">
                                            <div class="media-body">
                                                <a style="font-size: 20px;line-height: 19px; margin-bottom: 0px; color:#144874;"><?= esc($data['nama']) ?></a>
                    ...
                    <?php } else { ?>
                        <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                            <a target='_BLANK' style='color:red'>Belum ada data Layanan..!</a><br> Punya pertanyaan, keluhan, masukan atau saran, silahkan klik <b class="pointer" onclick="window.location.href='<?= base_url('masukansaran') ?>'">disini</b>, untuk sampaikan.
                        </div>
                    <?php } ?>
