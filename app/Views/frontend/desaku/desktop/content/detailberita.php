        ...
        <div class="row pb-5">
            <div class="col-md-1">
                <div class="share-button d-none d-sm-block position-sticky sticky-top">
                    ...
                    <ul>
                        <li class="mb-4 list-unstyled ml-0"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?href=<?= site_url('') . $berita->slug_berita ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/share-fb.png') ?>" /></a></li>
                        <li class="mb-4 list-unstyled ml-0"><a target="_blank" href="https://twitter.com/intent/tweet?text=<?= site_url() . $berita->slug_berita ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/share-tw.png') ?>" /></a></li>
                        <li class="mb-4 list-unstyled ml-0"><a target="_blank" href="https://web.whatsapp.com/send?text=<?= site_url() . $berita->slug_berita ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/wa.png') ?>" /></a></li>
                ...
                <div class="share-button d-sm-none">
                    ...
                    <ul>
                        <li class="mb-4 list-unstyled ml-0 mr-2 float-left"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?href=<?= site_url() . $berita->slug_berita ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/share-fb.png') ?>" /></a></li>
                        <li class="mb-4 list-unstyled ml-0 mr-2 float-left"><a target="_blank" href="https://twitter.com/intent/tweet?text=<?= site_url() . $berita->slug_berita ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/share-tw.png') ?>" /></a></li>
                        <li class="mb-4 list-unstyled ml-0 mr-2 float-left"><a target="_blank" href="https://web.whatsapp.com/send?text=<?= site_url() . $berita->slug_berita ?>"><img width="48" src="<?= base_url('/public/template/frontend/' . $folder . '/desktop/img/wa.png') ?>" /></a></li>
            ...
            <div class="col-md-11 px-md-5">
                ...
                <div class="article-detail mb-0">
                    ...
                    <div class="media mt-4 mb-4">
                        ...
                        <div class="media-body text-blue f-15">
                            ...
                            <span class="font-italic"><i class="bi bi-alarm"></i> <?= date_indo($berita->tgl_berita) ?> <i class="bi bi-eye"> </i><?= $berita->hits ?> x <i class="bi bi-folder2"></i> <a href="<?= base_url('category/' . $berita->slug_kategori) ?>"><?= esc($berita->nama_kategori) ?> </span>
                        </div>
                    </div>
                    <hr>
                    <img class="w-100 mb-1" src="<?= base_url('/public/img/informasi/berita/' . esc($berita->gambar)) ?>" />
                ...
                <?php if ($tag) { ?>
                    ...
                    ?>
                        ...
                        <a href="<?= base_url('tag/' . $data['tag_id'] . '/' . $data['slug_tag']) ?>" class="btn-secondary btn-sm mb-0 mr-1 text-blue"><i class="fas fa-tags mr-1"></i> <?= esc($data['nama_tag']) ?> </a>
                        <!-- </button> -->
                        <!-- </div> -->
                        ...
                        <div class="card mt-3">
                            <div class="card-header" id="section-header-1">
                                <h2 class="mb-0 roboto-700 text-blue f-25">
                                    Kolom Komentar
                                    <a href="#" class="float-right" data-toggle="collapse" data-target="#section-20" aria-expanded="true" aria-controls="section-20">
                                        <img src="<?= base_url('public/template/frontend/' . $folder . '/desktop/img/arrow-down.png') ?>" />
                                    </a>
                                </h2>
                            </div>
                            <div id="section-20" class="collapse show" aria-labelledby="section-header-20" data-parent="#section-article">
                                <div class="card-body text-gray roboto-400 f-14">
                                    <p dir="ltr" style="line-height:1.38;text-align: justify;margin-top:0pt;margin-bottom:0pt;" id="docs-internal-guid-3e79c859-7fff-f60c-861a-2588e498a307">
                                                        ...
                                                        <div class="item">
                                                            <?php foreach ($komen as $data) { ?>
                                                                <div class="comment-img">
                                                                    <img class="img-circle comment-img float-left" src="<?= base_url('public/template/backend/img/usr2.png') ?>" alt="<?= esc($data['nama_komen']) ?>">
                                                                </div>
                                                                <div>
                                                                ...
                                                                <?php if ($data['balas_komen'] != '') { ?>
                                                                    <div class="alert alert-light" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                                                                        <div class="comment-img">
                                                                            <img class="img-circle comment-img float-left" src="<?= base_url('public/img/user/' . esc($data['user_image'])) ?>" alt="<?= esc($data['fullname']) ?>">
                                                                        </div>
                                                                        <div>
                                                                            ...
                                                                            ?>
                                                                            <div class="author text-primary"><?= esc($data['fullname']) ?></div>
