        ...
        <div class="row article-container pb-5">
            ...
            <div class="col-md-12 px-md-5">
                <div class="article-detail mb-0">
                    <?php if ($hasil) { ?>
                        <h1 class="text-blue montserrat-700 f-30 text-center">Hasil Pencarian <b
                                class="text-danger"><?= esc($keyword) ?></b> </h1>
                    <?php } else { ?>
                    ...
                    <div class=" stretch-card grid-margin">
                        <?php if ($hasil) {
                            foreach ($hasil as $data) {
                                ...
                                if ($data['jenis_berita'] == 'Berita') {
                                    $img = image_url('informasi/berita/' . esc($data['gambar']));
                                    ...
                                    <div class="col-sm-4 grid-margin">
                                        <div class="position-relative">
                                            <div class="rotate-img">
                                                <img src="<?= $img ?>" alt="thumb" class="img-fluidx rounded" width="100%"
                                                    height="150" />
                                            </div>
                        ...
                        <?php } else { ?>
                            <div class="alert alert-light text-center"
                                ...
                                <span class="text-dark"> Maaf keyword <b class="text-danger"><?= esc($keyword) ?> </b> tidak
                                    ditemukan..!!</span>
                            </div>
                        <?php } ?>
