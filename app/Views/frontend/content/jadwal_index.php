            ...
            <div class="col-md-3">
                ...
                <div class="card mb-3">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="<?= base_url('jadwal/jenis/Ibadah Anak') ?>"
                            class="list-group-item list-group-item-action">
                            <i class="fas fa-child"></i> Ibadah Anak
                        </a>
                        <a href="<?= base_url('jadwal/jenis/Persekutuan Doa') ?>"
                            class="list-group-item list-group-item-action">
                        ...
                        <a href="<?= base_url('jadwal/jenis/Kebaktian Khusus') ?>"
                            class="list-group-item list-group-item-action">
                            <i class="fas fa-star"></i> Kebaktian Khusus
                        </a>
                        <a href="<?= base_url('jadwal/jenis/Acara Gereja') ?>"
                            class="list-group-item list-group-item-action">
