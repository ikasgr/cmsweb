                ...
                <div class="share-button d-none d-sm-block position-sticky sticky-top">
                    ...
                    <ul>
                        <li class="mb-4 list-unstyled ml-0"><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?href=<?= site_url('') . 'page/' . $berita->slug_berita ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/img/share-fb.png') ?>" /></a></li>
                        <li class="mb-4 list-unstyled ml-0"><a target="_blank"
                                href="https://twitter.com/intent/tweet?text=<?= site_url() . 'page/' . $berita->slug_berita ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/img/share-tw.png') ?>" /></a></li>
                        <li class="mb-4 list-unstyled ml-0"><a target="_blank"
                                href="https://web.whatsapp.com/send?text=<?= site_url() . 'page/' . $berita->slug_berita ?>"><img
                        ...
                        <div class="article-detail mb-0">
                            ...
                            <div class="media mt-4 mb-4">
                                <img width="35" class="mr-3 rounded-circle"
                                    src="<?= base_url('public/img/user/' . esc($berita->user_image)) ?>" />
                                <div class="media-body text-blue f-15">
                                    <h5 class="roboto-500 mt-0 mb-0 f-15"><?= esc($berita->fullname) ?></h5>
                                    <span class="font-italic"><i class="bi bi-alarm"></i>
                                        <?= date_indo($berita->tgl_berita) ?> <i class="bi bi-eye"></i>
                                        <?= $berita->hits ?> x </span>
                                </div>
                            </div>
                            <hr>
                            ...
                            if (esc($berita->gambar) != 'default.png') { ?>
                                <img class="w-100 mb-1"
                                    src="<?= base_url('/public/img/informasi/profil/' . esc($berita->gambar)) ?>"
                                    width="100%" alt="">
                            ...
                            <div class="roboto-400 f-20 mt-0">
                                <span
                                    ...
                                    if (esc($berita->filepdf) != '') { ?>
                                        <iframe src="<?= base_url('/public/img/informasi/pdf/' . esc($berita->filepdf)) ?>"
                                            ...
                                            <span class="meta-footer-thumb">
                                                <a
                                                    href="<?= base_url('author/' . $data['id'] . '/' . esc($data['fullname'])) ?>"><img
                                                        class="author-thumb"
                                                        src="<?= base_url('public/img/user/' . esc($data['user_image'])) ?>"
                                                        alt="Sal"></a>
                                            </span>
