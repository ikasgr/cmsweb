        ...
        <div class="col-md-8 mx-auto">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form action="<?= base_url('pendaftaran-baptis/submit') ?>" method="post"
                        enctype="multipart/form-data" id="form-baptis">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Tanggal ini bersifat usulan, akan dikonfirmasi oleh
                                admin</small>
                        </div>
