                ...
                <div class="share-button d-none d-sm-block position-sticky sticky-top">
                    ...
                    <ul>
                        <li class="mb-4"><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?href=<?php echo site_url('pengumuman') ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/img/share-fb.png') ?>" /></a></li>
                        <li class="mb-4"><a target="_blank"
                                href="https://web.whatsapp.com/send?text=<?= base_url('pengumuman/') ?>"><img width="48"
                                    src="<?= base_url('/public/template/frontend/img/wa.png') ?>" /></a></li>
                        <!-- <li><a href="#"><img width="48" src="<?= base_url() ?>/public/template/frontend/img/share-link.png" /></a></li> -->
                    </ul>
                        ...
                        <div class="row portfolio-container">
                            <?php if ($pengumuman) {
                                foreach ($pengumuman as $data) {
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 portfolio-item filter-1 wow fadeInUp"
                                        data-wow-delay="0.0s">
                                        <div class="portfolio-wrap">
                                            <div class="portfolio-imgx">
                                                <img height="250" width="100%"
                                                    src="<?= base_url('public/img/informasi/pengumuman/' . esc($data['gambar'])) ?>"
                                                    alt="Image">
                                            </div>
                                            <div class="portfolio-text">
                                                <h3><?= esc($data['nama']) ?></h3>
                                                <a class="btn" onclick="lihatpengumuman('<?= $data['informasi_id'] ?>')"
                                ...
                                <div class="alert alert-danger text-center"
                                    ...
                                    <a target='_BLANK' style='color:red'>Belum ada data Pengumuman..!</a><br> Punya
                                    pertanyaan, keluhan, masukan atau saran, silahkan klik <b class="pointer"
