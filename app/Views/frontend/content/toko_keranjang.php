                ...
                <div class="card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama-pembeli" placeholder="Masukkan nama Anda"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="alamat-pembeli" rows="2" placeholder="Alamat lengkap"
                                required></textarea>
                        </div>
