                ...
                <div class="article-detail mb-0">
                    ...
                    <?php if ($agenda) { ?>
                        ...
                        <div class="alert alert-info" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                            Anda Punya pertanyaan, keluhan, masukan atau saran, seputar pelayanan kami? Silahkan klik <b
                                class="pointer" onclick="window.location.href='<?= base_url('masukansaran') ?>'">disini</b>,
                            untuk sampaikan.
                        </div>
                        ...
                        foreach ($agenda as $data) {
                            ...
                            <div class="list-group mt-2">
                                <div class="list-group-item list-group-item-action "
                                    onclick="lihatagenda('<?= $data['agenda_id'] ?>')">
                                    <div class="row no-gutters pointer">
                                        <div class="media">
                                            <div class="media-body">
                                                <a
                                                    style="font-size: 16px;line-height: 19px; margin-bottom: 0px; color:#696969;"><?= esc($data['tema']) ?></a>
                    ...
                    <?php } else { ?>
                        <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                            <a target='_BLANK' style='color:red'>Belum ada data Agenda..!</a><br> Punya pertanyaan, keluhan,
                            masukan atau saran, silahkan klik <b class="pointer"
