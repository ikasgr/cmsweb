                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <span
                                class="badge badge-<?= $pesanan['status_pesanan'] == 'Pending' ? 'warning' : 'success' ?> badge-lg">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-borderless table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>: <span
                                            class="badge badge-warning"><?= esc($pesanan['status_pesanan']) ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right"><strong>Rp
                                            <?= number_format($pesanan['subtotal'], 0, ',', '.') ?></strong></td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right"><strong>Ongkir:</strong></td>
                                    <td class="text-right"><strong>Rp
                                            <?= number_format($pesanan['ongkir'], 0, ',', '.') ?></strong></td>
                                </tr>
                                <tr class="table-success">
                                    ...
                                    <td class="text-right">
                                        <h5 class="mb-0 text-success">Rp
                                            <?= number_format($pesanan['total_bayar'], 0, ',', '.') ?></h5>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
