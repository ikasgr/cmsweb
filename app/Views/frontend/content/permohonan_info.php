                ...
                <div class="article-detail mb-0">
                    ...
                    <div class="blog-comments mt-1">
                        ...
                        <div class="alert" style='background-color:#f4f4f4; border-color:#e3e3e3;'>
                            ...
                            Demi meningkatkan pelayanan bagi publik / masyarakat pada
                            <?= $konfigurasi->nama ?>, maka kami membuka permohonan informasi online yang dapat diakses
                            melalui website. Untuk melakukan permohonan informasi, mohon untuk mengisi formulir yang
                            sudah disediakan. Setelah melakukan pengisian dengan sebenar-benarnya, dimohon untuk
                            mengirimkan formulir tersebut, beserta dengan scan bukti diri, tanpa tanda bukti diri
                            permohonan anda kami anggap tidak sah.
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-12">
                                ...
                                <input type="email" class="form-control" id="email_pemohon" name="email_pemohon"
                                    placeholder="Email*">
                                <div class="invalid-feedback erroremail_pemohon"></div>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                <label for="">Nomor HP (WA) <a class="text-danger">*</a> </label>
                                <input type="text" class="form-control" id="hp_pemohon" name="hp_pemohon" maxlength="20"
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea type="text" id="alamat_pemohon" name="alamat_pemohon" class="form-control"
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <select class="form-control" name="pek_pemohon" id="pek_pemohon">
                                    <?php foreach ($pekerjaan as $key => $data) { ?>
                                        <option value="<?= $data['id_masterdata'] ?>"><?= esc($data['nama_master']) ?>
                                        </option>
                                    <?php } ?>
                            ...
                            <div class="form-group col-12">
                                <textarea type="text" id="info_ygdibutuhkan" name="info_ygdibutuhkan"
                                    class="form-control" placeholder="Informasi yang dibutuhkan*"></textarea>
                                <div class="invalid-feedback errorinfo_ygdibutuhkan"></div>
                            </div>
                            <div class="form-group col-12">
                                <textarea type="text" id="tujuan_info" name="tujuan_info" class="form-control"
                            ...
                            <div class="form-group col-8">
                                <br>
                                <button type="button" class="btn btn-primary btnkirim"><i
                                        class="fas fa-paper-plane"></i> Kirim Permohonan</button>
                            </div>
                        </div>
                        <?= form_close() ?>
