    ...
    <div class="card p-3">
        <div class="row article-container pb-5">
            ...
            <div class="col-md-12 px-md-5">
                    ...
                    <?php if ($surveytopik) { ?>
                        ...
                        <?php foreach ($surveytopik as $data) {
                            ...
                            <div class="alert alert-primary"
                                style='background-color:#f4f4f4; border-color:#e3e3e3;font-size:20px;'>
                        ...
                        <tr>
                            <td width="98%" valign="top" align="center" colspan="5"
                                ...
                                <font face="Arial" size="2"><b>Mohon kesediaan Anda untuk memberikan
                                    ...
                                    </b><i>Sebelum melanjutkan, Mohon mengisi Biodata Anda pada form yang telah disediakan
                                        dibawah.</i></font>
                            </td>
                        </tr>
                        <hr>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        value="<?= htmlentities(set_value('nama'), ENT_QUOTES) ?>" required>
                                </div>
                                <div class="form-group col-md-6 col-12">
                                    <label class="mt-2 ">No HP</label>

                                    <input type="text" class="form-control" id="nohp" name="nohp"
                                        value="<?= htmlentities(set_value('nohp'), ENT_QUOTES) ?>" required>
                                </div>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select name="id_pendidikan" id="id_pendidikan" class="form-control pointer">
                                        ...
                                        <?php foreach ($pendidikan as $key => $data) { ?>
                                            <option value="<?= esc($data['id_masterdata']) ?>"><?= esc($data['nama_master']) ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                        ...
                        if ($set) {
                            foreach ($set as $datatanya) {
                                ...
                                foreach ($set2 as $datajwb) {
                                    ...
                                    <label>
                                        <input name="jawaban_id[<?= $no ?>]" class="centang_id" required type="radio"
                                            value="<?= $datajwb['nilai'] ?>">
                                        <input type="hidden" id="nilai" name="nilai" value="<?= $datajwb['nilai'] ?>"
                                            class="form-control">
                            ...
                            <div class="text-left ">
                                ...
                                <textarea type="text" id="saran" name="saran"
                                    class="form-control"><?= htmlentities(set_value('saran'), ENT_QUOTES) ?></textarea>
                            </div>

                            <hr>
                            <center>
                                <input style='width: 120px; padding:2px; font-size:14px;' type=submit
                                    class='btn btn-primary btnsimpan' value='KIRIM DATA' />
                            </center>
                            <?= form_close() ?>
                        <?php } else { ?>
                ...
                <?php } else { ?>
                    <div class="alert alert-danger text-center" style='background-color:#FAEBD7; border-color:#e3e3e3;'>
                        <a style='color:red'>Belum Ada data Survey.!</a><br> Punya pertanyaan, keluhan, masukan atau saran,
                        silahkan klik <b class="pointer"
                            onclick="window.location.href='<?= base_url('masukansaran') ?>'">disini</b>, untuk sampaikan.
                    </div>
                <?php } ?>
