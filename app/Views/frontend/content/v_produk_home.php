                    ...
                    <div class="card h-100 shadow-sm product-card-home">
                        <div class="position-relative">
                            <a href="<?= base_url('toko/' . $produk['slug_produk']) ?>">
                                <?php
                                $img_path = 'public/img/produk/' . $produk['gambar'];
                                $img_produk = (file_exists($img_path) && !empty($produk['gambar'])) ? base_url($img_path) : base_url('public/img/produk/no_image.png');
                                ?>
                                <img src="<?= $img_produk ?>" class="card-img-top" alt="<?= esc($produk['nama_produk']) ?>"
