                ...
                <div class="share-button d-none d-sm-block position-sticky sticky-top">
                    ...
                    <ul>
                        ...
                        <li class="mb-4"><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?href=<?= base_url('category/' . $slug) ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/img/share-fb.png') ?>" /></a></li>
                        <li class="mb-4"><a target="_blank"
                                href="https://twitter.com/intent/tweet?text=<?= base_url('category/' . $slug) ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/img/share-tw.png') ?>" /></a></li>
                        <li class="mb-4"><a target="_blank"
                                href="https://web.whatsapp.com/send?text=<?= base_url('category/' . $slug) ?>"><img
                                    width="48" src="<?= base_url('/public/template/frontend/img/wa.png') ?>" /></a></li>
                    </ul>
                </div>
                <div class="share-button d-sm-none">
                    <h4 class="montserrat-700 f-20 text-blue mb-4">Bagikan artikel</h4>
                    <ul>
                        <li class="mb-4 mr-2 float-left"><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?href=<?= base_url('category/' . $slug) ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/img/share-fb.png') ?>" /></a></li>
                        <li class="mb-4 mr-2 float-left"><a target="_blank"
                                    ...
                                    <div class="col-sm-4 grid-margin">
                                        <div class="position-relative">
                                            <div class="rotate-img">
                                                <img src="<?= image_url('informasi/berita/' . esc($data['gambar'])) ?>"
                                                    alt="thumb" class="img-fluidx rounded" width="100%" height="150" />
                                            </div>
                                            <div class="badge-positioned">
                                                <a
                                                    href="<?= base_url('author/' . $data['id'] . '/' . esc($data['fullname'])) ?>">
                                                    <span
                                                        class="badge badge-primary font-weight-bold"><?= esc($data['fullname']) ?></span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-8  grid-margin">
                                        <h2 class="mb-0 roboto-700 text-blue f-20">
                                            <a class="text-secondary"
                                                href="<?= base_url($data['slug_berita']) ?>"><?= esc($data['judul_berita']) ?></a>
                                        </h2>
