                ...
                <div class="share-button d-none d-sm-block position-sticky sticky-top">
                    ...
                    <ul>
                        ...
                        <li class="mb-4"><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?href=<?php echo site_url('berita/') ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/desktop/img/share-fb.png') ?>" /></a>
                        </li>
                        <li class="mb-4"><a target="_blank"
                                href="https://twitter.com/intent/tweet?text=<?php echo site_url('berita/') ?>"><img
                                    width="48"
                                    src="<?= base_url('/public/template/frontend/desktop/img/share-tw.png') ?>" /></a>
                        </li>
                        <li class="mb-4"><a target="_blank"
                                href="https://web.whatsapp.com/send?text=<?php echo site_url('berita/') ?>"><img
                                    width="48"
            ...
            <div class="col-md-11 px-md-5">
                <div class="article-detail mb-0">
                    ...
                    <div class="text-center bg-lightx">
                        ...
                        <?php } ?>
                        <img class="pic alignnone photo rounded" alt=""
                            src="<?= base_url('public/img/user/' . esc($dt['user_image'])) ?>" style="max-width: 200px">
                        <!-- <p>&nbsp;</p> -->
                        <h4 class="categories-title title"><?= esc($subtitle) ?> <i class="fa fa-check-circle"
                                style="color:#305b90;">
                            </i></h4>
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="badge-positioned">
                                                <a href="<?= base_url('category/' . $data['slug_kategori']) ?>">
                                                    <span
                                                        class="badge badge-danger font-weight-bold"><?= esc($data['nama_kategori']) ?></span>
                                                </a>
