                            ...
                            foreach ($album as $key => $data) {
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 mb-4">
                                    ...
                                    <div class="bg-light rounded shadow-sm pointer">
                                        <a href="<?= base_url('foto/detail/' . $data['kategorifoto_id']) ?>"><img
                                                src="<?= base_url('/public/img/galeri/katfoto/' . esc($data['cover_foto'])) ?>"
                                                alt="" class="img-fluidx card-img-top" width="100%" height="200"></a>
                                        <div class="p-2">
                                            <span> <a href="<?= base_url('foto/detail/' . $data['kategorifoto_id']) ?>"
                                                    class="text-dark"><?= esc($data['nama_kategori_foto']) ?></a></span>
