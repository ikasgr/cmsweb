                    ...
                    <?php if (isset($produk->nama_kategori)): ?>
                        <?php if (isset($produk->slug_kategori)): ?>
                            <li class="breadcrumb-item"><a
                                    href="<?= base_url('toko/kategori/' . $produk->slug_kategori) ?>"><?= esc($produk->nama_kategori) ?></a>
                            </li>
                        <?php else: ?>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card shadow-sm">
                    <?php
                    $main_img_path = 'public/img/produk/' . $produk->gambar;
                    $main_img_src = (file_exists($main_img_path) && !empty($produk->gambar)) ? base_url($main_img_path) : base_url('public/img/produk/no_image.png');
                    ?>
                    <img src="<?= $main_img_src ?>" class="card-img-top" alt="<?= esc($produk->nama_produk) ?>"
                ...
                <div class="mt-3 text-center">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=<?= current_url() ?>&text=<?= esc($produk->nama_produk) ?>"
                        target="_blank" class="btn btn-info btn-sm mr-2">
                        <i class="fab fa-twitter"></i> Twitter
                    </a>
                    <a href="https://wa.me/?text=<?= esc($produk->nama_produk) ?> - <?= current_url() ?>"
                            ...
                            <div class="col-md-3 col-sm-6 mb-3">
                                <div class="card h-100 shadow-sm">
                                    <a href="<?= base_url('toko/' . $item['slug_produk']) ?>">
                                        <?php
                                        $rel_img_path = 'public/img/produk/' . $item['gambar'];
                                        $rel_img_src = (file_exists($rel_img_path) && !empty($item['gambar'])) ? base_url($rel_img_path) : base_url('public/img/produk/no_image.png');
                                        ?>
                                        <img src="<?= $rel_img_src ?>" class="card-img-top"
                                            alt="<?= esc($item['nama_produk']) ?>" style="height: 150px; object-fit: cover;">
                                    </a>
