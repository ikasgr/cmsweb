            ...
            <div class="col-md-9">
                ...
                <?php if (isset($produk) && $produk): ?>
                    <div class="alert alert-success">
                        ...
                        Ditemukan <strong><?= isset($total) ? $total : count($produk) ?></strong> produk untuk kata kunci
                        "<strong><?= isset($keyword) ? esc($keyword) : '' ?></strong>"
                    </div>
                ...
                <?php else: ?>
                    <div class="alert alert-warning">
                        ...
                        Tidak ada produk yang ditemukan untuk kata kunci
                        "<strong><?= isset($keyword) ? esc($keyword) : '' ?></strong>".
                    </div>
