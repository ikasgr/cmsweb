<?php if ($dbnewonline != 'errkoneksi') { ?>
    <input type="hidden" class="form-control" id="id_setaplikasi" value="<?= $id_setaplikasi ?>" name="id_setaplikasi"
        readonly>
    ...
    <?php if ($verdb != $dbnewonline) { ?>
        ...
        <div class="alert alert-warning alert-dismissible fade show d-flex align-items-start shadow-sm" role="alert">
            ...
            <div>
                ...
                <p class="mb-2 text-dark">Sebelum memulai proses pembaruan, pastikan Anda telah melakukan <strong>backup
                        data</strong> untuk menghindari kehilangan informasi.</p>
                <ul class="list-unstyled mb-2">
                    ...
                    <li>
                        ...
                        <span class="text-dark"> Simpan konfigurasi database (nama database, username, dan password) di file
                            <code>app\Config\Database.php</code>.</span>
                    </li>
                </ul>
                <small class="text-muted">
                    Pembaruan hanya dapat dilanjutkan setelah proses migrasi selesai dan database diperbarui ke versi
                    <strong><?= $dbnewonline ?></strong>.
                </small>
            </div>
        ...
        <div class="card border-0 shadow-sm mt-4">
            <div class="card-body text-center">
                ...
                <div class="progress mb-3 d-none" id="progress-container">
                    <div id="progress-bar1" class="progress-bar bg-info" role="progressbar" style="width: 0%;" aria-valuenow="0"
    ...
    <?php if ($verdb === $dbnewonline) { ?>
        ...
        <div class="alert alert-info text-center"
            style="background-color: #f8f9fa; border-color: #e3e3e3; border-radius: 8px; padding: 20px;">
            <img src="<?= base_url('public/template/backend/assets/images/coming-soon.png') ?>" alt="Success" width="300"
                style="max-height: 100%; margin-bottom: 15px;">
            ...
            <div class="alert alert-primary alert-dismissible fade show mb-0" role="alert" style="border-radius: 6px;">
                ...
                <small>
                    <span class="d-block mt-1">Belum menjadi <b>member Pro</b>? <a href="https://ikasmedia.com/paketmember"
                            class="alert-link">Aktifkan sekarang</a> sebagai bentuk dukungan untuk pengembangan CMS ini.</span>
                </small>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        </div>
...
<?php } else { ?>
    <center>
        <img class="" src="<?= base_url('public/template/backend/assets/images/err.png') ?>" alt="not found" width="200"
            height="100%">

        <div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
            </button>
            Maaf, tidak dapat terhubung ke Server <a href="https://ikasmedia.com" class="alert-link">IKASMEDIA</a>.
        </div>
    </center>
<?php } ?>
