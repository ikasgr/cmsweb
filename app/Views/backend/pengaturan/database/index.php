                ...
                <div class="card-body">
                    <div id="ket" class="mb-0">
                        <div class="alert alert-info alert-dismissible fade show border border-info" role="alert">
                            ...
                            <h6 class="alert-heading"><i class="fas fa-info-circle"></i> <strong> Informasi Pembaruan
                                    Sistem</strong> </h6>
                            <p>
                                Pastikan server Anda mendukung ekstensi <strong> OpenSSL</strong> agar pembaruan dapat
                                berjalan dengan lancar.
                                <br>
                                <small class="text-muted"> Saat ini, Anda menggunakan CMS versi
                                    <strong><?= esc($vercms) ?></strong> dan Database versi
                                    <strong><?= esc($verdb) ?></strong>.</small>
                        </div>
                    </div>
                    <div id="ketsukses" class="mb-0">
                        ...
                        <div class="alert alert-success d-flex align-items-start show p-2" role="alert">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Anda sedang menggunakan CMS Ikasmedia versi <a
                                        class="text-danger"><?= esc($vercms) ?></a> dan Database versi <a
                                        class="text-danger"><?= esc($verdb) ?></a>.</small>
                            </div>
                        </div>
                    ...
                    <center>
                        <input type="text" autocomplete="off" autofocus id="fileUrl" class="form-control"
                            placeholder="Silakan masukkan nama file akses yang telah Anda terima." name="fileUrl" />
                        <button id="start-konek" class="btn btn-primary btn-block mt-2" onclick="listdataupdate()"
                            style="width: 200px;">
