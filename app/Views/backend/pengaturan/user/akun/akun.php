            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-group text-center mb-1">
                        <img class="img-thumbnail logoweb pointer" onclick="gantilogo('<?= $id ?>')"
                            src="<?= base_url('public/img/user/' . $profil) ?>" alt="Foto Profil" width="210px">
                    </div>
                    <?php if ($role) {
                        foreach ($role as $row):
                        endforeach;
        ...
        <div class="col-lg-8">
            <div class="card m-b-20">
                ...
                <div class="modal-footer p-1">
                    <button type="button" onclick="lihat('<?= $id ?>')" class="btn btn-info"><i
                            class="fa fa-search"></i> Lihat Statistik Postingan</button>
                    <button type="button" class="btn btn-primary btnupload"><i class="mdi mdi-content-save-all"></i>
                        Update Data</button>
                </div>
