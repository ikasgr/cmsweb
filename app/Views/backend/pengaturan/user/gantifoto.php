<div class="modal fade" id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <br>
            <center>
                <img class="img-thumbnail" id="img_load" src="<?= base_url('public/img/user/' . $profil) ?>"
                    alt="Foto Profil" width="120px">
            </center>
            ...
            <div class="modal-footer p-1">
                <button type="button" class="btn btn-primary btnupload"><i class="mdi mdi-content-save"></i>
                    Simpan</button>
