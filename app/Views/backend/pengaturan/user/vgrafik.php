...
<div class="card-body border-top text-center pb-0 dash-info-widgetx pt-1 p-2">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="mt-4 mt-sm-0">
                <p class="text-muted text-truncate"><i
                        class="mdi mdi-checkbox-multiple-blank-circle text-info font-size-11 mr-1"></i> Bulan ini :</p>
        ...
        <div class="col-sm-4 dash-goal">
            <div class="mt-4 mt-sm-0">
                <p class=" text-muted text-truncate"><i
                        class="mdi mdi-checkbox-multiple-blank-circle text-primary font-size-11 mr-1"></i> Total
                    Kunjungan :</p>
                <div class="d-inline-flex">
        ...
        <div class="col-sm-4 dash-goal">
            <div class="mt-4 mt-sm-0">
                <p class=" text-muted text-truncate"><i
                        class="mdi mdi-checkbox-multiple-blank-circle text-success font-size-11 mr-1"></i> Sedang Online
                    :</p>
                <div class="d-inline-flex">
