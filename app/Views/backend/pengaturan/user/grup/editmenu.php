    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title mt-0">Ubah Akses Menu Dashboard</h5>
                                    ...
                                    <tr class="mb-0">
                                        ...
                                        <td class="p-1">
                                            <select name="aksesmenu[]" class="form-control form-control-sm pointer">
                                                ...
                                                <option value="0" <?php if ($data['aksesmenu'] == '0')
                                                    echo "selected"; ?>>
                                                    Sembunyikan Menu</option>
                                                <option value="1" <?php if ($data['aksesmenu'] == '1')
                                                    echo "selected"; ?>>
                                        ...
                                        <td style="display:none"> <input type="hidden" name="id_modul[]"
                                                value="<?= $data['id_modul'] ?>" class="form-control"></td>
                                        <td style="display:none"> <input type="hidden" name="id_grupakses[]"
                                                value="<?= $data['id_grupakses'] ?>" class="form-control">
