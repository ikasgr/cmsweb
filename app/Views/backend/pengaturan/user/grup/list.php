<a href="<?= base_url('user/') ?>" class="btn btn-warning btn-sm "><i class="far fa-arrow-alt-circle-left font-14"></i>
    Kembali</a>
<?php if ($tambah == 1) { ?>
...
<small class="text-secondary"> Hak Akses untuk <strong class="text-danger"> Hanya Data Miliknya, </strong> pada beberapa
    modul sama dengan <strong class="text-warning"> Hanya bisa melihat data</strong>. </small>
<hr>
            ...
            foreach ($list as $data):
                ...
                <tr>
                    ...
                    <td class="text-center p-1">
                        ...
                        <button type="button" class="btn btn-light btn-sm p-1" title="Ganti Nama Grup"
                            onclick="editnama('<?= $data['id_grup'] ?>')">
                            <i class="icon fas fa-edit text-primary"></i>
                        </button>
                        <button type="button" class="btn btn-social btn-flat btn-light btn-sm p-1" title="Lihat Hak Akses"
                            onclick="lihatakses('<?= $data['id_grup'] ?>')">
                            <i class="icon fas fa-search text-success"></i>
                        </button>

                        <?php if ($data['jenis'] != '1') { ?>
                            <?php if ($data['sts_menu'] != '1' && $tambah == 1) { ?>
                                <button type="button" class="btn btn-secondary btn-sm p-1" title="Tambah Akses Menu"
                                    onclick="addmenu('<?= $data['id_grup'] ?>')">
                                    <i class="icon fas fa-sliders-h text-light"></i>
                                </button>
                            <?php } else { ?>
                                <?php if ($ubah == 1) { ?>
                                    <button type="button" class="btn btn-social btn-flat btn-light btn-sm p-1" title="Ubah Akses Menu"
                                        onclick="editmenu('<?= $data['id_grup'] ?>')">
                                        <i class="icon fas fa-chalkboard-teacher text-primary"></i>
                                    </button>
                                    <button type="button" class="btn btn-light btn-sm p-1" title="Ubah Hak Akses"
                                        onclick="edit('<?= $data['id_grup'] ?>')">
