                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12 mb-2">
                                ...
                                <input type="text" class="form-control" id="folder" value="<?= esc($folder) ?>"
                                    name="folder" <?= in_array(esc($folder), $readOnlyFolders) ? 'readonly' : '' ?>>
                            ...
                            <div class="form-group col-md-3 col-12 mb-2">
                                ...
                                <input type="number" id="hplogo" name="hplogo" value="<?= esc($hplogo) ?>"
                                    placeholder="pixel" class="form-control">
                            ...
                            <div class="form-group col-md-3 col-12 mb-2">
                                ...
                                <input type="number" id="wllogo" name="wllogo" value="<?= esc($wllogo) ?>"
                                    placeholder="pixel" class="form-control">
                            ...
                            <div class="form-group col-md-3 col-12 mb-2">
                                ...
                                <input type="number" id="hpbanner" name="hpbanner" value="<?= esc($hpbanner) ?>"
                                    placeholder="pixel" class="form-control">
                            ...
                            <div class="form-group col-md-3 col-12 mb-2">
                                ...
                                <input type="number" id="wlbanner" name="wlbanner" value="<?= esc($wlbanner) ?>"
                                    placeholder="pixel" class="form-control">
                                <div class="invalid-feedback errorwlbanner"></div>
                            </div>
                            <div class="form-group col-md-6 col-12 mb-2">
                                <label> <i class="mdi mdi-clipboard-check-outline"></i> Versi bootstrap <small>(Modal
                                        Popup)</small></label>
                                <div class="form-control p-0">
                                    &nbsp;<input type="radio" name="verbost" id="verbost2" value="0" <?= $verbost == '0' ? 'checked' : '' ?>> <label for="verbost2" class="pointer pt-2"> Ver. 4x
                                        &nbsp</label>
                            ...
                            <div class="form-group col-md-6 col-12 mb-2">
                                <label> <i class="mdi mdi-clipboard-check-outline"></i> Gunakan 2 tema <small>(desktop &
                                        mobile)</small></label>
                                <div class="form-control p-0">
                                    &nbsp;<input type="radio" name="duatema" id="duatema2" value="0" <?= $duatema == '0' ? 'checked' : '' ?>> <label for="duatema2" class="pointer pt-2"> Tidak
                                        &nbsp</label>
