<script
    src="<?= base_url() ?>/public/template/backend/assets/libs/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
<script src="<?= base_url() ?>/public/template/backend/assets/libs/bootstrap-colorpicker/js/form-advanced.js"></script>
<link
    href="<?= base_url() ?>/public/template/backend/assets/libs/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css"
    rel="stylesheet" /> -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class='card-body pt-0'>
                <input type="hidden" class="form-control" id="template_id" value="<?= $template_id ?>"
                    name="template_id" readonly>
                ...
                <div class="tab-content text-muted pt-3">
                        ...
                        <div class="row ">
                            <div class="form-group col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama" value="<?= esc($nama) ?>"
                                        name="nama">
                            ...
                            <div class="form-group col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <?php if (esc($folder) == '' || esc($folder) == 'morvin') { ?>
                                        <input type="text" class="form-control" id="folder" value="<?= esc($folder) ?>"
                            ...
                            <div class="form-group col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="colorpicker-default form-control form-control"
                                        id="warna_topbar" name="warna_topbar" value="<?= esc($warna_topbar) ?>">
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-control p-0">
                                        &nbsp;<input type="radio" name="sidebar_mode" id="sidebar_mode2" value="0"
                                            <?= $sidebar_mode == '0' ? 'checked' : '' ?>> <label for="sidebar_mode2"
                                            class="pointer pt-2"> Light &nbsp;</label>
                                        <input type="radio" name="sidebar_mode" id="sidebar_mode1" value="1"
                                            <?= $sidebar_mode == '1' ? 'checked' : '' ?>> <label for="sidebar_mode1"
                                            class="pointer pt-2"> Dark </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="text" class="form-control" id="pembuat" value="<?= esc($pembuat) ?>"
                                    name="pembuat">
                    ...
                    <div class="tab-pane" id="cover" role="tabpanel">
                        ...
                        <?php if (esc($img) != '' && esc($img) != 'default.png') { ?>
                            <div class="form-group">
                                <center>
                                    <img class="img-thumbnail " id='img_load' width='80%'
                                        src='<?= base_url('public/img/template/' . esc($img)) ?>'>
                                </center>
                            </div>
                        <?php } ?>
                        </p>
