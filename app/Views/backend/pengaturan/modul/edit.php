            ...
            <div class="modal-body">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <select name="gm" id="gm" class="form-select pointer">
                            ...
                            <?php foreach ($modulmenu as $key => $data) { ?>
                                <option value="<?= esc($data['gm']) ?>" <?= esc($gm) == esc($data['gm']) ? 'selected' : '' ?>>
                                    <?= esc($data['modul']) ?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        ?>
                        <input type="text" id="urlmenu" name="urlmenu" value="<?= esc($urlmenu) ?>"
                            placeholder="Link Controler utk Akses Modul" class="form-control" <?= $ron ?>>
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ikonmn" name="ikonmn" value="<?= esc($ikonmn) ?>"
                            placeholder="Jika tdk dijadikan menu abaikan." class="form-control">
                    </div>
