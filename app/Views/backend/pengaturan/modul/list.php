                ...
                <tr>
                    ...
                    <td class="text-center p-1">
                        <?php if ($akses == 1) { ?>
                            ...
                            <button type="button" class="btn btn-light btn-sm p-1" title="Kelola Hak Akses"
                                onclick="setakses('<?= $data['id_modul'] ?>','<?= esc($urlmenu) ?>')">
                            ...
                            <?php } else { ?>
                                <button type="button" class="btn btn-light btn-sm p-1"
                                    onclick="hapus('<?= $data['id_modul'] ?>','<?= esc($data['modul']) ?>')">
