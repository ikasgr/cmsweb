    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control" id="id_modpublic" value="<?= $id_modpublic ?>"
                    name="id_modpublic" readonly>
                <div class="form-group row mb-2">
                    <label for="" class="col-sm-3 col-form-label">Modul</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="modpublic" value="<?= esc($modpublic) ?>"
                            name="modpublic">
