            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="gm" name="gm" value="<?= esc($gm) ?>" class="form-control" readonly>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="urlmenu" name="urlmenu" placeholder="Link Controler utk Akses Modul"
                            class="form-control">
