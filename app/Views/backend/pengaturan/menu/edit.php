            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <select class="form-select pointer" name="parent" id="parent">
                            <option value="Y" data-menu_link="#" <?= $parent == 'Y' ? 'selected' : '' ?>>Menu Induk
                            </option>
                ...
                <div id="single">
                    <div class="form-group mb-2">
                        <label>Sumber Link</label> <small class="text-secondary">(Isi Pilihan jika Link hendak
                            diganti)</small>
                    ...
                    <input type="hidden" id="linkexternal" name="linkexternal" value="<?= esc($linkexternal) ?>"
                        class="form-control">
                </div>
                <!-- end single -->
                ...
                <div class="form-group  mb-2">
                    ...
                    <input type="text" class="form-control" id="menu_linkold" name="menu_linkold" readonly
                        value="<?= esc($menu_link) ?>">
                </div>
