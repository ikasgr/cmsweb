                ...
                <tr>
                    ...
                    <td class="p-1">
                        <?php if (esc($data['iconssm']) != '') { ?>
                            &nbsp; <i class="<?= esc($data['iconssm']) ?> text-secondary"
                                title="<?= esc($data['iconssm']) ?>"></i><a class="text-warning font-12"></a>
                        <?php } ?>
                    ...
                    <td class="p-1">
                        ...
                        <a target="_blank"
                            href="<?php echo base_url(esc($data['link_subsubmenu'])) ?>"><?= esc($data['link_subsubmenu']) ?>
                        </a>
                    </td>
                    ...
                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            <?php if ($data['stsssm'] == '1') { ?>
                                <button type="button" onclick="toggle('<?= $data['subsubmenu_id'] ?>')"
                                    class="btn btn-circle btn-sm p-1 <?= $data['stsssm'] ? 'btn-light' : 'btn-success' ?>"
                                    title="<?= $data['stsssm'] ? 'Non Aktifkan' : 'Aktifkan' ?>"><i
                                        class="fas fa-check-circle text-success"></i>
                                </button>
                            <?php } else { ?>
                                <button type="button" onclick="toggle('<?= $data['subsubmenu_id'] ?>')"
                                    class="btn btn-circle btn-sm p-1 <?= $data['stsssm'] ? 'btn-light' : 'btn-light' ?>"
                                    title="<?= $data['stsssm'] ? 'Non Aktifkan' : 'Aktifkan' ?>"><i
                                        class="nav-icon far fa-eye text-danger"></i>
                                </button>
                            <?php } ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['subsubmenu_id'] ?>')">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['subsubmenu_id'] ?>')">
