            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <div class="form-control p-0">
                            &nbsp; <input type="radio" id="posisi1" name="posisi" value="1" checked><label for="posisi1"
                                class="pointer pt-2">&nbsp Top Menu &nbsp</label>
                            <input type="radio" id="posisi2" name="posisi" value="2"><label for="posisi2"
                                class="pointer pt-2">&nbsp Footer &nbsp</label>
                        </div>
                    </div>
                </div>
                <!-- Single menu start -->
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <div class="form-control p-0">
                            &nbsp; <input type="radio" id="target1" name="target" value="0" checked> <label
                                for="target1" class="pointer pt-2">_parent &nbsp</label>
                            <input type="radio" id="target2" name="target" value="1"> <label for="target2"
                                class="pointer pt-2"> _blank &nbsp</label>
                        </div>
                    </div>
                </div>
                <div class="row">
