                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <div class="form-control p-0">
                            &nbsp <input type="radio" id="parentsm1" name="parentsm" value="N" checked><label
                                for="parentsm1" class="pointer pt-2">&nbspTidak &nbsp</label>
                            <input type="radio" id="parentsm2" name="parentsm" value="Y"><label for="parentsm2"
                                class="pointer pt-2">&nbspYa &nbsp</label>
