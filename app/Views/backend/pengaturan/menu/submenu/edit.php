            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nama_submenu" name="nama_submenu" value="<?= esc($nama_submenu) ?>"
                            class="form-control ">
                ...
                <div>
                    <div class="form-group mb-2" id="berita">
                        ...
                        <select name="dberita" id="dberita" class="form-select pointer">
                            ...
                            <?php foreach ($kategoriberita as $key => $data) { ?>
                                <option data-link_submenu="category/<?= esc($data['slug_kategori']) ?>">
                    ...
                    <div class="form-group mb-2" id="halaman">
                        ...
                        <select name="dhalaman" id="dhalaman" class="form-select pointer">
                            ...
                            <?php foreach ($halaman as $key => $data) { ?>
                                <option data-link_submenu="page/<?= esc($data['slug_berita']) ?>">
                    ...
                    <div class="form-group mb-2" id="modul">
                        ...
                        <select class="form-select pointer" name="modulcms" id="modulcms">
                            ...
                            <?php foreach ($modulpublic as $key => $data) { ?>
                                <option data-link_submenu="<?= esc($data['link']) ?>"><?= esc($data['modpublic']) ?>
                                </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group mb-2" id="eksternal">
                        ...
                        <input type="text" id="link_submenu" name="link_submenu" value="<?= $link_submenu ?>"
                            class="form-control ">
                        <div class="invalid-feedback errorlink_submenu"></div>
                    </div>
                    <input type="hidden" id="linkexternalsm" name="linkexternalsm" value="<?= $linkexternalsm ?>"
                        class="form-control ">
                </div>
                <div class="form-group mb-2">
                    <label>Link Sebelumnya</label>
                    <input type="text" id="link_submenuold" name="link_submenuold" readonly value="<?= $link_submenu ?>"
                        class="form-control ">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" class="form-control " id="iconsm" name="iconsm" value="<?= esc($iconsm) ?>">
                    </div>
