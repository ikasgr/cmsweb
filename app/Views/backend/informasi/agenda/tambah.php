...
<div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
       ...
       data-date-start-view="years" data-date-min-view-mode="days"> -->
                        ...
                        <input type="text" class="form-control" name="tgl_mulai" placeholder="dd M, yyyy"
                            data-date-format="dd M, yyyy" data-date-container='#tgl_mulai' data-provide="datepicker"
                    ...
                    <div class="form-group col-md-3 col-12 mb-2" id="tgl_selesai">
                        ...
                        <input type="text" class="form-control" name="tgl_selesai" placeholder="dd M, yyyy"
                            data-date-format="dd M, yyyy" data-date-container='#tgl_selesai' data-provide="datepicker"
                            data-date-autoclose="true">
