            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="pengirim" name="pengirim" value="<?= esc($pengirim) ?>"
                            class="form-control">
                    ...
                    <div class="form-group col-md-4 col-12 mb-2" id="tglmulai">
                        ...
                        <input type="text" class="form-control" id="tgl_mulai" name="tgl_mulai"
                            value="<?= shortdate_indo($tgl_mulai) ?>" data-date-format="dd M, yyyy"
                            data-date-container='#tglmulai' data-provide="datepicker" data-date-autoclose="true">
                    ...
                    <div class="form-group col-md-4 col-12 mb-2" id="tglselesai">
                        ...
                        <input type="text" class="form-control" id="tgl_selesai" name="tgl_selesai"
                            value="<?= shortdate_indo($tgl_selesai) ?>" data-date-format="dd M, yyyy"
                            data-date-container='#tglselesai' data-provide="datepicker" data-date-autoclose="true">
