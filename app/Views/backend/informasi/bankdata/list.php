        ...
        <tbody>
            ...
            foreach ($list as $data):
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($tambah == 1) { ?>
                            <?php if (esc($data['fileupload']) != '') { ?>
                                <i class="fas fa-file-alt text-success pointer" onclick="uploadfile('<?= $data['bankdata_id'] ?>')"
                                    title="Ganti file"></i>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if (esc($data['fileupload']) != '') { ?>
                            <a href="<?= base_url('public/unduh/bankdata/' . esc($data['fileupload'])) ?>" title="Lihat file"
                    ...
                    <td class="text-center p-1">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['bankdata_id'] ?>','<?= esc($data['nama_bankdata']) ?>')">
