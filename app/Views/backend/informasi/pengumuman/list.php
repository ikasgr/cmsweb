                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <?php if (esc($data['gambar']) == 'default.png') { ?>
                            <span class="badge badge-soft-warning pointer" style="font-size:12px" <?= $eksekusi ?>
                                title="Tambahkan Cover">No Cover </span>
                        <?php } else { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Gambar" <?= $eksekusi ?>
                                src="<?= base_url('public/img/informasi/pengumuman/' . esc($data['gambar'])) ?>" height="100%"
                                width="45px">
                        <?php } ?>
                    </td>
                    <td class="text-center ">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['informasi_id'] ?>','<?= $data['nama'] ?>')">
