    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control" id="fasilitas_id" value="<?= $fasilitas_id ?>"
                    name="fasilitas_id" readonly>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" rows="3" id="lokasi" name="lokasi"
                        class="form-control"><?= $lokasi ?></textarea>
                </div>
            </div>
