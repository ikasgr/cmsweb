...
<a href="<?= base_url('fasilitas/list/') ?>" class="btn btn-warning btn-sm "><i
            ...
            foreach ($list as $data):
                ...
                <tr>
                    <td class="p-1 text-center">
                        <input type="checkbox" name="fasilitasdetail_id[]" class="centang_id"
                            value="<?= $data['fasilitasdetail_id'] ?>">
                    </td>
                    <td class="p-1 text-center"><?= $nomor ?></td>

                    <td class="p-1"><img class="img-circle elevation-2"
                            src="<?= base_url('/public/img/informasi/fasilitas/detail/' . $data['gambar']) ?>" width="130px"
                            height="80px"></td>
                    ...
                    <td class="text-center p-1">
                        ...
                        <?php if ($ubah == 1) { ?>
                            <button type="button" title="Edit Data" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['fasilitasdetail_id'] ?>')">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['fasilitasdetail_id'] ?>','<?= $data['deskripsi'] ?>')">
