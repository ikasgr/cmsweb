        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="transparan_nama" name="transparan_nama" value="<?= esc($transparan_nama) ?>"
                        class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="transparan_jumlah" name="transparan_jumlah"
                        value="<?= $transparan_jumlah ?>" class="form-control">
