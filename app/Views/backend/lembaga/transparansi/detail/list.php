...
<a href="<?= base_url('transparansi/list/') ?>" class="btn btn-warning btn-sm "><i
            ...
            foreach ($list as $data):
                ...
                <tr>
                    <td class="p-1 text-center">
                        <input type="checkbox" name="transparandetail_id[]" class="centang_id"
                            value="<?= $data['transparandetail_id'] ?>">
                    </td>
                    ...
                    <td class="text-center p-1">
                        <?php if ($akses == 1) { ?>
                            <button type="button" title="Edit Data" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['transparandetail_id'] ?>','<?= $data['transparan_id'] ?>')">
                                <i class="fa fa-edit text-primary"></i>
                            </button>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['transparandetail_id'] ?>','<?= $data['transparan_nama'] ?>')">
