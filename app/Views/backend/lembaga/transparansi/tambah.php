        ...
        <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <div class="form-control p-0">
                            &nbsp; <input type="radio" id="jenis1" name="jenis" value="0" checked> <label for="jenis1"
                                class="pointer pt-2">Pendapatan &nbsp</label>
                            <input type="radio" id="jenis2" name="jenis" value="1"> <label for="jenis2"
                                class="pointer pt-2"> Belanja &nbsp</label>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btnsimpan"><i class="mdi mdi-content-save-all"></i>
                    Simpan</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="ion-close"></i>
                    Tutup</button>
            </div>
