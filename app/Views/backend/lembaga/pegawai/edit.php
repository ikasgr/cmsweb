            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type=" text" id="tempat_lahir" name="tempat_lahir" value="<?= esc($tempat_lahir) ?>"
                            class="form-control">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2" id="tgllahir">
                        ...
                        <input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir"
                            value="<?= shortdate_indo($tgl_lahir) ?>" data-date-format="dd M, yyyy"
                            data-date-container='#tgllahir' data-provide="datepicker" data-date-autoclose="true">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type=" text" id="pangkat" name="pangkat" value="<?= esc($pangkat) ?>"
                            class="form-control">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="jabatan" name="jabatan" value="<?= esc($jabatan) ?>"
                            class=" form-control">
