    ...
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <small>#. Pengisian data dimulai dari baris kedua (lihat contoh di format excel).
                        <br> #. Untuk Format excelnya dapat diunduh <a target='_BLANK'
                            href="<?= base_url('public/file/Format Data Pegawai.xlsx') ?>"><i
                                class="far fa-file-excel text-success"></i><label class="text-info"></label> Disini</a>
                    </small>
                </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary btnsimpan"><i class=" fas fa-sync-alt"></i> Proses
                    Import</button>
