            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2" id="tgllahir">
                        ...
                        <input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="dd M, yyyy"
                            data-date-format="dd M, yyyy" data-date-container='#tgllahir' data-provide="datepicker"
