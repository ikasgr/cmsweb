    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card mb-3">
                ...
                <div class='card-body'>
                    <input type="hidden" class="form-control" id="id_setaplikasi" value="<?= $id_setaplikasi ?>"
                        name="id_setaplikasi" readonly>

                    <div class="form-group">
                        <label> <i class="mdi mdi-text-shadow"></i>
                            Isi Sambutan
                        </label>
                        <textarea type="text" class="form-control" id="sambutan"
                            name="sambutan"> <?= $sambutan ?></textarea>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="form-group text-center mb-2">
                        <?php if ($akses == 1) { ?>
                            <img class="img-thumbnail pointer" onclick="gantilogo('<?= $id_setaplikasi ?>')"
                                src="<?= base_url('public/img/konfigurasi/pimpinan/' . esc($gbr_sambutan)) ?>"
                                alt="Gambar Sambutan">
                        <?php } else { ?>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" id="nama_pimpinan" value="<?= esc($nama_pimpinan) ?>" name="nama_pimpinan"
                            class="form-control">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" id="jabatan_pimpinan" value="<?= esc($jabatan_pimpinan) ?>"
                            name="jabatan_pimpinan" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control">
                            <input type="radio" name="sts_sambutan" value="1" <?= $sts_sambutan == '1' ? 'checked' : '' ?>>
                            Ya &nbsp
                            <input type="radio" name="sts_sambutan" value="0" <?= $sts_sambutan == '0' ? 'checked' : '' ?>>
                            Tidak &nbsp
