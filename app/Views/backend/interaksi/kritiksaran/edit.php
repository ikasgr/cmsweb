            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nohp_usr" name="nohp_usr" value="<?= esc($no_hpusr) ?>"
                ...
                <div class="form-group mb-2">
                    <label> <i class="mdi mdi-message-processing"></i>Isi Kritik / Saran <small> (Anda dapat sensor
                            pesan yang tidak pantas.) </small></label>
                    <textarea type="text" rows="1" class="form-control bg-light" id="isi_kritik"
                        name="isi_kritik"><?= esc($isi_kritik) ?></textarea>
