            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="telp" name="telp" value="<?= esc($telp) ?>" class=" form-control"
                            readonly>
                ...
                <div class="form-group  mb-2">
                    ...
                    <input type="text" id="instansi" name="instansi" value="<?= esc($instansi) ?>" class="form-control"
                        readonly>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="bidang" name="bidang" value="<?= esc($bidang) ?>" class=" form-control"
                        readonly>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea type="text" class="form-control bg-light" id="keperluan" name="keperluan"
                        readonly><?= esc($keperluan) ?></textarea>
