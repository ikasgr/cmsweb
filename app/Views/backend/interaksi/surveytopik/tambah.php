            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_stb" name="ket_stb" class=" form-control form-control-sm"
                            placeholder="Cth: Sangat tidak baik">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_kb" name="ket_kb" class=" form-control form-control-sm"
                            placeholder="Cth: Kurang Baik">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_b" name="ket_b" class=" form-control form-control-sm"
                            placeholder="Cth: Baik">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_sb" name="ket_sb" class=" form-control form-control-sm"
                ...
                <small>
                    <strong class="text-danger"> Keterangan hasil</strong>, diisi berurutan seperti contoh di
                    placeholder. (dimulai dari terkecil) </small>
                </small>
