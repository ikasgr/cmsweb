...
<a href="<?= base_url('survey/all/') ?>" class="btn btn-warning btn-sm "><i
    ...
    <table id="listpertanyaan" class="table table-hover table-striped table-bordered">
        ...
        <tbody>
            ...
            foreach ($list as $data):
                ...
                <tr>
                    <td>
                        <input type="checkbox" name="pertanyaan_id[]" class="centang_id"
                            value="<?= $data['pertanyaan_id'] ?>">
                    </td>
                    <td><?= $nomor ?></td>
                    <td>
                    ...
                    <td class="text-center p-0">
                        <a href="<?= base_url('survey/jawaban/' . $data['pertanyaan_id']) ?>" title="Manajemen Jawaban"
                        ...
                        <?php if ($ubah == 1) { ?>
                            <button type="button" title="Edit Data" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['pertanyaan_id'] ?>','<?= $data['survey_id'] ?>')">
                        ...
                        <?php if ($jjawab == 0 && $hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['pertanyaan_id'] ?>','<?= esc($data['pertanyaan']) ?>')">
