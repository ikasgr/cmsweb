            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-12">
                        ...
                        <input type="text" class="form-control form-control-sm" id="nama_pemohon" name="nama_pemohon"
                            value="<?= esc($nama_pemohon) ?>" readonly>

                    </div>
                    <div class="form-group col-md-4 col-12">
                        <label for="">E-mail </label>
                        <input type="email" class="form-control form-control-sm" id="email_pemohon" name="email_pemohon"
                            value="<?= esc($email_pemohon) ?>" readonly>

                    </div>
                    <div class="form-group col-md-4 col-12">
                        <label for="">Nomor HP (WA) </label>
                        <input type="text" class="form-control form-control-sm" id="hp_pemohon" name="hp_pemohon"
                            value="<?= esc($hp_pemohon) ?>" readonly>

                    </div>
                    <div class="form-group col-12">
                        <label for="">Alamat </label>
                        <textarea type="text" class="form-control form-control-sm bg-light" id="alamat_pemohon"
                            name="alamat_pemohon" readonly><?= esc($alamat_pemohon) ?></textarea>

                    </div>
                    <div class="form-group col-md-6 col-12">
                        <label for="">Pekerjaan </label>
                        <input type="text" class="form-control form-control-sm" id="pekerjaan" name="pekerjaan"
                            value="<?= esc($pekerjaan) ?>" readonly>
                    </div>

                    <div class="form-group col-md-6 col-12">
                        <label for="">Identitas Diri </label>

                        <label class="form-control  form-control-sm"><a class="text-success"
                                title="klik untuk buka file" target='_BLANK'
                                href="<?= base_url('public/file/dokumen/' . $foto_ktp) ?>"><?= $foto_ktp ?></a></label>
                    </div>

                    <div class="form-group col-12">
                        <label for="">Informasi yang dibutuhkan </label>
                        <textarea type="text" class="form-control form-control-sm bg-light" id="info_ygdibutuhkan"
                            name="info_ygdibutuhkan" readonly><?= esc($info_ygdibutuhkan) ?></textarea>
                        <div class="invalid-feedback errorinfo_ygdibutuhkan"></div>
                    </div>
                    <div class="form-group col-12">
                        <label for="">Tujuan Penggunaan Informasi </label>
                        <textarea type="text" class="form-control form-control-sm bg-light" id="tujuan_info"
                            name="tujuan_info" readonly><?= esc($tujuan_info) ?></textarea>

                    </div>

                    <div class="form-group col-md-6 col-12">
                        <label for="">Cara Memperoleh Informasi </label>
                        <input type="text" class="form-control form-control-sm" id="caraperolehinfo"
                            name="caraperolehinfo" value="<?= esc($caraperolehinfo) ?>" readonly>
                    </div>
                    <div class="form-group col-md-6 col-12">
                        <label for="">Cara Mendapatkan Informasi </label>
                        <input type="text" class="form-control form-control-sm" id="caradapatinfo" name="caradapatinfo"
                            value="<?= esc($caradapatinfo) ?>" readonly>
                    </div>
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" class="form-control form-control-sm" id="caraperolehinfo"
                            name="caraperolehinfo" value="<?= $tglk . ' ' . $blnck . ' ' . $thnk . ' ' . $jamk ?>"
                            readonly>
                    </div>
                    <div class="form-group col-12">
                        ...
                        <textarea type="text" class="form-control form-control-sm" id="respon_balas"
                            name="respon_balas"><?= $respon_balas ?></textarea>
                ...
                <div class="modal-footer p-0">
                    <?php if ($akses == 1) { ?>
                        <div class="float-right">
                            <button class="btn btn-primary btnupload"><i class="fas fa-paper-plane"></i> Kirim
                                Balasan</button>
                        </div>
                    <?php } ?>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="ion-close"></i>
                        Tutup</button>
