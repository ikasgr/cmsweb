    ...
    <table id="permohonaninfo" class="table table-hover table-striped table-bordered  dt-responsiveZ nowrapx">
        ...
        <tbody>
            ...
            foreach ($list as $value):
                ...
                <tr>
                    <td>
                        <input type="checkbox" name="id_mohoninfo[]" class="centangid"
                            value="<?= $value['id_mohoninfo'] ?>">
                    </td>
                    <!-- NAMA -->
                    <td class="p-1">
                        <a href="<?= base_url('public/file/dokumen/' . $foto_ktp) ?>" title="klik untuk buka file"
                            target='_BLANK'><i class="mdi mdi-file-account text-primary" style="font-size: 16px;"></i></a>
                        <?php if ($sts_info == '0') { ?>
                            <b><?= esc($nama) ?></b>
                        <?php } else { ?>
                            <?= esc($nama) ?>
                    ...
                    <td class="text-center p-0">
                        ...
                        <?php if ($sts_info == '0') { ?>
                            <button type="button" class="btn btn-circle btn-sm p-1 btn-light"
                                title="Ajuan Baru/Belum ditanggapi"><i
                                    class="fas fa-arrow-circle-right font-14 text-warning"></i>
                            </button>
                        <?php } else if ($sts_info == '1') { ?>
                                <button type="button" class="btn btn-circle btn-sm p-1 btn-light" title="Ajuan diterima"><i
                                        class="far fa-check-circle font-14 text-success"></i>
                                </button>
                        <?php } else { ?>
                                <button type="button" class="btn btn-circle btn-sm p-1 btn-light" title="Ajuan ditolak"><i
                                        class="far fa-times-circle font-14 text-danger"></i>
                                </button>
                        <?php } ?>
                        ...
                        <?php if ($ubah == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= esc($value['id_mohoninfo']) ?>')">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $value['id_mohoninfo'] ?>','<?= esc($nama) ?>')">
