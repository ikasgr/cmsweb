            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-12">
                        ...
                        <input type="text" id="nama" name="nama" value="<?= esc($nama) ?>" class="form-control form-control-sm">
                    ...
                    <div class="form-group col-md-4 col-12">
                        ...
                        <input type="text" id="nik" name="nik" value="<?= esc($nik) ?>" class=" form-control form-control-sm">
