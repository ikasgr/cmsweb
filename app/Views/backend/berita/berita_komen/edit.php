            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nama_komen" name="nama_komen" value="<?= $nm ?>" class="form-control"
                            readonly>
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="email_komen" name="email_komen" value="<?= esc($email_komen) ?>"
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="tanggal_komen" name="tanggal_komen"
                            value="<?= $tglk . ' ' . $blnck . ' ' . $thnk . ' ' . $jamk ?>" class="form-control"
                            readonly>
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="hp_komen" name="hp_komen" value="<?= esc($hp_komen) ?>"
                            class=" form-control" readonly>
                ...
                <div class="form-group mb-2">
                    <label class="text-primary"><i class="mdi mdi-clipboard-check-outline"></i> Aktifkan Komentar
                    </label>
                ...
                <div class="form-group mb-2">
                    ...
                    <?php if (esc($balas_komen) != '') { ?>
                        <textarea type="text" class="form-control" id="balas_komen"
                            name="balas_komen"><?= esc($balas_komen) ?></textarea>
                    <?php } else { ?>
                        <textarea type="text" class="form-control" id="balas_komen" name="balas_komen"
                            autofocus>@<?= $nm ?>, </textarea>
                    <?php } ?>
                </div>
                ...
                <div class="modal-footer p-0">
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
                            class="mdi mdi-cancel"></i> Tutup</button>
