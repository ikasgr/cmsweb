    ...
    <table id="listkomen" class="table table-hover table-striped table-bordered">
        ...
        <tbody>
            ...
            foreach ($list as $value):
                ...
                <tr>
                    <td>
                        <input type="checkbox" name="beritakomen_id[]" class="centangid mt-3"
                            value="<?= $value['beritakomen_id'] ?>">
                    </td>
                    <td>
                        <?= $value['sts_komen'] == '0'
                    ...
                    <td class="text-center p-0">
                        <button type="button" onclick=""
                            class="mt-3 btn btn-sm <?= $value['sts_komen'] == '1' ? 'btn-light text-success' : 'btn-light text-danger' ?>"
                            title="<?= $value['sts_komen'] == '1' ? 'Telah ditanggapi' : 'Belum ditanggapi' ?>">
                            <i
                                class="fas <?= $value['sts_komen'] == '1' ? 'fa-check-circle' : 'fa-arrow-circle-right' ?> font-20"></i>
                        </button>
                        <?php if ($ubah == 1) { ?>
                            <button type="button" class="mt-3 btn btn-light btn-sm"
                                onclick="edit('<?= $value['beritakomen_id'] ?>')">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="mt-3 btn btn-light btn-sm"
                                onclick="hapus('<?= $value['beritakomen_id'] ?>','<?= htmlentities($value['nama_komen']) ?>')">
