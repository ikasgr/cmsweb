                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="mb-0">
                            <div class="row">
                                ...
                                <div class="form-group col-md-7 col-12 mb-3">
                                    ...
                                    <input type="text" id="tgl_berita" name="tgl_berita"
                                        value="<?= shortdate_indo(date('Y-m-d')) ?>"
                                        class="form-control date-picker pointer">
                                ...
                                <div class="form-group col-12 mb-3">
                                    ...
                                    <textarea type="text" rows="8" id="ringkasan" name="ringkasan"
                                ...
                                <div class="form-group col-12 mb-3">
                                    ...
                                    <select name="kategori_id" id="kategori_id" class="form-control select2 pointer"
                                        ...
                                        <?php foreach ($kategori as $key => $data) { ?>
                                            <option value="<?= $data['kategori_id'] ?>"><?= esc($data['nama_kategori']) ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="tag_id[]" id="tag_id" class="form-control" placeholder=" Pilih Tagar"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-control  p-0">
                                    &nbsp; <input type="radio" id="sts_komen1" name="sts_komen" value="0" checked>
                                    <label for="sts_komen1" class="form-check-label pointer pb-2 pt-2">Tidak
                                        &nbsp</label>
                                    <input type="radio" id="sts_komen2" name="sts_komen" value="1"> <label
                                        for="sts_komen2" class="form-check-label pointer pb-2 pt-2"> Ya &nbsp</label>
                                </div>
                            ...
                            <div class="modal-footer p-0">
                                <button class="btn btn-primary btnsimpan"><i class="mdi mdi-content-save-all"></i>
                                    Simpan</button>
