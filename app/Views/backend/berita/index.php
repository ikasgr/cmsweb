        ...
        <div class="col-12">
            <div class="card m-b-20">
                ...
                <div class="card-body">
                    ...
                    <?php if ($tambah == 1) { ?>
                        <a href="<?= base_url('add-new') ?>"> <button type="button" class="btn btn-primary btn-sm"><i
                                    class="fas fa fa-plus-circle"></i> Tambah baru</button></a>
                    <?php } ?>
                    ...
                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                        ...
                        <table id="databerita" class="table table-striped table-hover "
