        ...
        <tbody>
            ...
            foreach ($list as $data):
                ...
                <tr>
                    ...
                    <td class="p-1"><?= esc($data['nama_kategori']) ?> <a class="text-danger"
                            title="Jumlah berita">(<?= $jberita ?>)</a>
                    </td>

                    <td class="p-1">
                        <i class="mdi mdi-link-variant"></i>
                        <a target="_blank"
                            href="<?php echo base_url('category/' . $data['slug_kategori']) ?>">category/<?= esc($data['slug_kategori']) ?></a>
                    </td>

                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['kategori_id'] ?>')">
                        ...
                        <?php if ($jberita == 0 && $hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['kategori_id'] ?>')">
