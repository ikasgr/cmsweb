        ...
        <div class="modal-content">
            ...
            <div class="modal-footer p-1">
                <?php if ($list['sts_tombol'] != 0) { ?>
                    <a class="btn btn-info" href="<?= esc($list['linktawaran']) ?>"
                        style="padding: 5px;"><?= esc($list['namatombol']) ?></a>
                <?php } ?>
                <?php if ($konfigurasi['verbost'] == 0) { ?>
                    <a class="btn btn-danger text-light" style="padding: 5px;" data-dismiss="modal"
                        onclick="nonaktifpenawaran()">Jangan Tampilkan lagi</a>

                <?php } else { ?>
                    <a class="btn btn-danger text-light" style="padding: 5px;" data-bs-dismiss="modal"
                        onclick="nonaktifpenawaran()">Jangan Tampilkan lagi</a>
                <?php } ?>
            </div>
        </div>
