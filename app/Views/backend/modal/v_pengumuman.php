    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img id='img_load' width='100%'
                    src='<?= base_url('public/img/informasi/pengumuman/' . esc($gambar)) ?>'>
                <!-- </div> -->
                            ...
                            <?php if (esc($fileunduh) != '') { ?>
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <a href="<?= base_url('public/unduh/pengumuman/' . esc($fileunduh)) ?>"
                                            target="_blank" class="ml-3 btn btn-success" type="button">Download File</a>
