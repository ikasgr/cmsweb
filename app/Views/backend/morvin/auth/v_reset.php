                    ...
                    <div class="card-body">
                        ...
                        <form class="mb-1" autocomplete="off | unknown-autocomplete-value">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="password" class="form-control" name="password" id="password" onkeyup="checkPasswordStrength(this.value)" value="<?= htmlentities(set_value('password'), ENT_QUOTES) ?>" placeholder="Enter password">
                        ...
                        <div class="text-center">
                            <a href="<?= base_url(esc($konfigurasi->kecamatan)) ?>" class="d-flex align-items-center justify-content-center">
