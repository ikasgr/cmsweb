    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    <img src="<?= base_url('/public/img/informasi/pegawai/' . esc($gambar)) ?>" alt="Profil" class="img-thumbnail p-0">
                </center>
                    ...
                    <?php if (esc($filetupoksi) != '') { ?>
                        <tr>
                            ...
                            <td class="p-1" width="50%">
                                <a href="<?= base_url('/public/img/informasi/pegawai/' . esc($filetupoksi)) ?>" target="_blank">
