            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Foto" onclick="gantifoto('<?= $data['pegawai_id'] ?>')" src="<?= base_url('public/img/informasi/pegawai/' . esc($data['gambar'])) ?>" height="40px" width="45px" alt="<?= esc($data['nama']) ?>">
                        <?php } else { ?>
                            <img class="img-circle elevation-2" src="<?= base_url('public/img/informasi/pegawai/' . esc($data['gambar'])) ?>" height="40px" width="45px" alt="<?= esc($data['nama']) ?>">
                        <?php } ?>
                    </td>
                    <td>
                        <?php if ($akses == 1) { ?>
                            ...
                            <?= esc($data['nama']) ?>
                            <?php if ($data['filetupoksi'] != '') { ?>
                                <i class="far fa-trash-alt text-warning pointer" onclick="hapuspdf('<?= $data['pegawai_id'] ?>','<?= esc($data['nama']) ?>')" title="Hapus file tupoksi"></i>
                            <?php }  ?>
                        <?php } else { ?>
                    ...
                    <td class="text-center p-1">
                        ...
                        <button type="button" title="Detail Pegawai" class="btn btn-light btn-sm p-1" onclick="lihatpegawai('<?= $data['pegawai_id'] ?>')">
                            <i class="fas fa-search text-success"></i>
                        </button>

                        <?php if ($ubah == 1) { ?>
                            <button type="button" title="Edit Data" class="btn btn-light btn-sm p-1" onclick="edit('<?= $data['pegawai_id'] ?>')">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $data['pegawai_id'] ?>','<?= esc($data['nama']) ?>')">
