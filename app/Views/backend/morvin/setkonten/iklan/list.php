        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="p-1">
                        <?php if ($ubah == 1) { ?>
                            <img class="img-circle elevation-2 pointer" onclick="gantibanner('<?= $value['id_banner'] ?>')" title="Ganti banner" src="<?= base_url('/public/img/banner/' . esc($value['banner_image'])) ?>" width="100" height="40">
                        <?php } else { ?>
                            <img class="img-circle elevation-2" src="<?= base_url('/public/img/banner/' . esc($value['banner_image'])) ?>" width="100">
                        <?php } ?>
                    </td>
                    ...
                    <td class="text-center p-0">
                        ...
                        <?php } ?>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['id_banner'] ?>','<?= esc($value['ket']) ?>')">
