            ...
            foreach ($list as $value) :
                ...
                <tr>
                    ...
                    <td class=" text-center">
                        ...
                        <?php } else { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Gambar" onclick="gantifoto('<?= $value['section_id'] ?>')" src="<?= base_url('/public/img/section/' . esc($value['gambar'])) ?>" width="80" height="50">
                        <?php } ?>
                    ...
                    <td class="text-center ">
                        ...
                        <?php } ?>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['section_id'] ?>','<?= esc($value['nama_section']) ?>')">
