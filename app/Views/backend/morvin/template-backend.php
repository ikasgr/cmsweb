...
<head>
    ...
    <link href="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/css/bootstrap.min.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/css/icons.min.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/css/app.min.css?v2') ?>" rel="stylesheet" type="text/css">
    <!-- Summernote css -->
    <link href="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/summernote/summernote-lite.min.css') ?>" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/select2/css/select2.min.css') ?>" rel="stylesheet" type="text/css" />
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box shadow-lg">
                        <a href="<?= base_url('dashboard') ?>" class="logo logo-dark">
                            ...
                            <span class="logo-sm">
                                <img class="mt-1 ml-3 img-thumbnailx" src="<?= base_url('/public/img/konfigurasi/icon/' . esc($konfigurasi->icon)) ?>" alt="" height="40">
                            </span>

                            <span class="logo-lg">
                                <img class="pt-3" src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/images/cwpv11.png') ?>" alt="" height="65">
                            </span>
                        </a>

                        <a href="<?= base_url('dashboard') ?>" class="logo logo-light ">
                            <span class="logo-sm">
                                <img src="<?= base_url('/public/img/konfigurasi/icon/' . esc($konfigurasi->icon)) ?>" alt="" height="30">
                            </span>
                            <span class="logo-lg pt-2">
                                <img src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/images/cwpv11.png') ?>" alt="" height="50">
                            </span>
                        </a>
                    </div>
...
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/metismenu/metisMenu.min.js') ?>"></script>
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/simplebar/simplebar.min.js') ?>"></script>
...
<!-- Summernote js -->
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/summernote/summernote-lite.min.js') ?>"></script>
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/select2/js/select2.min.js?v2') ?>"></script>
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/toastr/toastr.js') ?>"></script>
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/toastr/ui-toasts.js') ?>"></script>
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/libs/chart.js/Chart.bundle.min.js') ?>"></script>
...
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/js/pages/fontawesome.init.js') ?>"></script>
<script src="<?= base_url('/public/template/backend/' . esc($folder) . '/assets/js/pages/materialdesign.init.js') ?>"></script>