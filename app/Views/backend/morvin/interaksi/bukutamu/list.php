            ...
            foreach ($list as $value) :
                ...
                <tr>
                    ...
                    <td class="text-center p-0">
                        <button type="button" class="btn btn-light btn-sm p-1" onclick="edit('<?= $value['bukutamu_id'] ?>','<?= $value['bidang_id'] ?>')">
                            <i class="fas fa-search text-success"></i>
                        </button>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['bukutamu_id'] ?>','<?= $value['bukutamu_id'] ?>')">
