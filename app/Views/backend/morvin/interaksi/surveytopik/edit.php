        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="nama_survey" value="<?= esc($nama_survey) ?>" name="nama_survey">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="ket_stb" name="ket_stb" value="<?= esc($ket_stb) ?>" class="form-control form-control-sm" placeholder="Sangat tidak baik">
