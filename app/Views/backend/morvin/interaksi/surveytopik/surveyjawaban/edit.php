            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-8 col-12">
                        ...
                        <input type="text" id="jawaban" name="jawaban" value="<?= esc($jawaban) ?>" class="form-control">
                    ...
                    <div class="form-group col-md-4 col-12">
                        ...
                        <input type="number" id="nilai" name="nilai" value="<?= esc($nilai) ?>" class="form-control" readonly>
