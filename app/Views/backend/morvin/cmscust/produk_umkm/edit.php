                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <?php if ($data['gambar']) : ?>
                                <div class="mb-2">
                                    <img src="<?= base_url('public/img/produk/' . $data['gambar']) ?>" class="img-thumbnail" width="200" id="preview-gambar">
                                </div>
                            <?php else : ?>
                                <div class="mb-2">
                                    <img src="<?= base_url('public/img/no-image.png') ?>" class="img-thumbnail" width="200" id="preview-gambar">
                                </div>
                            <?php endif; ?>
                            <input type="file" class="form-control mt-2" name="gambar" id="input-gambar" accept="image/*">
                            <small class="text-muted">Kosongkan jika tidak ingin mengubah gambar. Max 2MB, Format: JPG, JPEG, PNG</small>
                            <div class="invalid-feedback errorgambar"></div>
                        </div>

                        <div class="form-group mb-3">
                            <label>Nama Produk <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="nama_produk" value="<?= esc($data['nama_produk']) ?>" placeholder="Masukkan nama produk">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="deskripsi" rows="4" placeholder="Deskripsi produk"><?= esc($data['deskripsi']) ?></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="harga" value="<?= $data['harga'] ?>" placeholder="0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="harga_promo" value="<?= $data['harga_promo'] ?>" placeholder="0">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="stok" value="<?= $data['stok'] ?>" placeholder="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="berat" value="<?= $data['berat'] ?>" placeholder="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="whatsapp_admin" value="<?= esc($data['whatsapp_admin'] ?? '') ?>" placeholder="628123456789">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="whatsapp_template" rows="3" placeholder="Halo, saya tertarik dengan produk ini..."><?= esc($data['whatsapp_template'] ?? 'Halo, saya tertarik dengan produk:
    ...
    function gantigambar(id_produk) {
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                formData.append('csrf_tokencmsdatagoe', $('input[name=csrf_tokencmsdatagoe]').val());
