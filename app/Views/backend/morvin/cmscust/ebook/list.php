                ...
                <tr>
                    ...
                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            ...
                            <?php } else { ?>
                                <img class="img-circle elevation-2 pointer" title="Ganti Gambar" onclick="ganticover('<?= $value['ebook_id'] ?>')" src="<?= base_url('public/img/ebook/' . esc($value['gambar'])) ?>" width="40px">
                            <?php } ?>
                        <?php } else { ?>
                            <?php if (esc($value['gambar']) == 'default.png') { ?>
                                <span class="badge badge-warning " style="font-size:12px">No Cover </span>
                            <?php } else { ?>
                                <img class="img-circle elevation-2 " src="<?= base_url('public/img/ebook/' . esc($value['gambar'])) ?>" width="50px">
                            <?php } ?>
                        <?php } ?>
                    </td>
                    <td class="p-1">
