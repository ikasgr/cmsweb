...
<div class="table-responsive mt-3">
    <table id="listpesanan" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            if ($data['status_pembayaran'] == 'Lunas') $badge_bayar = 'success';
                            elseif ($data['status_pembayaran'] == 'Pending') $badge_bayar = 'warning';
                            ?>
                        ...
                        <td>
                            <?php
                            $badge_status = 'info';
                            if ($data['status_pesanan'] == 'Selesai') $badge_status = 'success';
                            elseif ($data['status_pesanan'] == 'Dibatalkan') $badge_status = 'danger';
                            elseif ($data['status_pesanan'] == 'Dikirim') $badge_status = 'primary';
                            ?>
                        ...
                        <td>
                            ...
                            <?php if ($akses == '1' || $akses == '2') : ?>
                                <button type="button" class="btn btn-warning btn-sm" onclick="updatestatus('<?= $data['id_pesanan'] ?>')">
