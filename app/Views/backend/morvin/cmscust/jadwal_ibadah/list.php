    ...
    <div class="col-md-4">
        <form class="formsearch">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="keyword" name="keyword" placeholder="Cari jadwal, tema, tempat...">
...
<div class="table-responsive">
    <table class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabelJadwal">
        ...
        <tbody>
            ...
            <?php foreach ($list as $data) : ?>
                <tr>
                    <td>
                        <?php if ($akses == '1' || $akses == '2') { ?>
                            <input type="checkbox" class="form-check-input centangid" name="id_jadwal[]" value="<?= $data['id_jadwal'] ?>">
                        <?php } ?>
                    </td>
                    <td><?= $nomor++ ?></td>
                    <td>
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-info btn-sm" onclick="lihat('<?= $data['id_jadwal'] ?>')" title="Lihat Detail">
                                <i class="fas fa-eye"></i>
                            </button>
                            
                            <?php if ($akses == '1' || $akses == '2') { ?>
                                <button type="button" class="btn btn-warning btn-sm" onclick="edit('<?= $data['id_jadwal'] ?>')" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </button>
                                
                                <button type="button" class="btn btn-secondary btn-sm" onclick="toggle('<?= $data['id_jadwal'] ?>', '<?= esc($data['judul_ibadah']) ?>')" title="Ubah Status">
                                    <i class="fas fa-exchange-alt"></i>
                                </button>
                                
                                <button type="button" class="btn btn-primary btn-sm" onclick="copy('<?= $data['id_jadwal'] ?>', '<?= esc($data['judul_ibadah']) ?>')" title="Copy Jadwal">
                                    <i class="fas fa-copy"></i>
                                </button>
                                
                                <button type="button" class="btn btn-danger btn-sm" onclick="hapus('<?= $data['id_jadwal'] ?>', '<?= esc($data['judul_ibadah']) ?>')" title="Hapus">
