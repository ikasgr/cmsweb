<div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="modaltambahLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open('pendaftaran-nikah/simpan', ['class' => 'formtambah']) ?>
            <?= csrf_field(); ?>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_lengkap_suami" class="form-control" placeholder="Nama lengkap suami">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_lahir_suami" class="form-control" placeholder="Tempat lahir suami">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp_suami" class="form-control" placeholder="08xxxxxxxxxx">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_suami" class="form-control" rows="2" placeholder="Alamat lengkap suami"></textarea>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_lengkap_istri" class="form-control" placeholder="Nama lengkap istri">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_lahir_istri" class="form-control" placeholder="Tempat lahir istri">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp_istri" class="form-control" placeholder="08xxxxxxxxxx">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_istri" class="form-control" rows="2" placeholder="Alamat lengkap istri"></textarea>
