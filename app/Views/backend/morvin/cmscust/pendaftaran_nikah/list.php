...
<div class="table-responsive mt-3">
    <table id="listpendaftarannikah" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <small class="text-muted"><?= esc($data['tempat_lahir_pria']) ?>, <?= date_indo($data['tanggal_lahir_pria']) ?></small>
                        </td>
                        <td>
                            <strong><?= esc($data['nama_wanita']) ?></strong><br>
                            <small class="text-muted"><?= esc($data['tempat_lahir_wanita']) ?>, <?= date_indo($data['tanggal_lahir_wanita']) ?></small>
                        </td>
                        <td>
