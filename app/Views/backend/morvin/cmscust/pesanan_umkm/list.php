...
<?= $this->section('menu') ?>
<?= $this->include('backend/' . $folder . '/menu') ?>
<?= $this->endSection() ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-outline-primary filter-status active" data-status="">
                                        <i class="fas fa-list"></i> Semua
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-warning filter-status" data-status="Pending">
                                        <i class="fas fa-clock"></i> Pending
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-info filter-status" data-status="Diproses">
                                        <i class="fas fa-cog"></i> Diproses
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-primary filter-status" data-status="Dikirim">
                                        <i class="fas fa-shipping-fast"></i> Dikirim
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-success filter-status" data-status="Selesai">
                                        <i class="fas fa-check-circle"></i> Selesai
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-danger filter-status" data-status="Dibatalkan">
                        ...
                        <div class="table-responsive">
                            <table id="listpesanan" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="keterangan" id="keterangan" class="form-control" rows="3" placeholder="Keterangan update status (opsional)"></textarea>
                </div>
            </div>
