                ...
                <div class="card mini-stat bg-warning text-white">
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <h4 class="fw-medium font-size-24"><?= $pending ?> <i class="mdi mdi-arrow-up text-white ms-2"></i></h4>
                        </div>
                        <div class="pt-2">
                            <div class="float-end">
                                <a href="<?= base_url('pesanan-umkm/list') ?>" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
                            </div>
