            ...
            ?>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <?php } else { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Gambar" onclick="gantifoto('<?= $data['agenda_id'] ?>')" src="<?= base_url('public/img/informasi/agenda/' . esc($data['gambar'])) ?>" height="100%" width="55px">
                        <?php } ?>
                    </td>
                    <td class="text-center">
                        ...
                        <?php } ?>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $data['agenda_id'] ?>','<?= esc($data['tema']) ?>')">
