            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if (esc($data['fileupload']) != '') { ?>
                            <a href="<?= base_url('public/unduh/bankdata/'  . esc($data['fileupload'])) ?>" title="Lihat file" target="_blank"><i class="fas fa-search"></i></a>
                        <?php } ?>
                    ...
                    <td class="text-center p-1">
                        ...
                        <?php } ?>
                        <?php if ($hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $data['bankdata_id'] ?>','<?= esc($data['nama_bankdata']) ?>')">
