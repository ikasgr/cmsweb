        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    <h4 class="text-light"><i class="fas fa-chart-bar"></i> Penilaian Layanan</h4>
            ...
            <div class="col-sm-6">
                <div class="float-end d-none d-sm-block">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('layanan/all') ?>">Layanan</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card m-b-20">
                ...
                <input type="hidden" value="<?= $informasi_id ?>" id="informasi_id" name="informasi_id">
                <div class="card-body">
...
<script>
    function listpoling() {
        ...
        $.ajax({
            url: "<?= site_url('layanan/getpoling') ?>",
            data: {
