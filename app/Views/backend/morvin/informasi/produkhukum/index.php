        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    <h4 class="text-light"><i class="mdi mdi-scale-balance"></i> Data Produk <?= esc($subtitle) ?></h4>
            ...
            <div class="col-sm-6">
                <div class="float-end d-none d-sm-block">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Produk <?= esc($subtitle) ?></li>
                    </ol>
            ...
            <div class="card m-b-20">
                ...
                <!-- <div class="card-header font-18 bg-light">
                    <h6 class="modal-title mt-0">
                        <i class="mdi mdi-scale-balance"></i> Data Produk <?= esc($subtitle) ?>
                    </h6>
                </div> -->
