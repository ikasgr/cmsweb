        ...
        <tbody>
            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td>
                        <?php if (esc($data['skathukum']) != '1') {
                            if ($tambah == 1) {
                                if (esc($data['file_kathukum']) != 'default.png' && (esc($data['file_kathukum']) != null)) { ?>
                        ...
                        <?php if (esc($data['skathukum']) != '1') {
                            if (esc($data['file_kathukum']) != 'default.png' && (esc($data['file_kathukum']) != null)) { ?>
                                <a href="<?= base_url('public/unduh/produkhukum/'  . esc($data['file_kathukum'])) ?>" title="Lihat file" target="_blank"><i class="fas fa-search"></i></a>
                        <?php }
                        } ?>
