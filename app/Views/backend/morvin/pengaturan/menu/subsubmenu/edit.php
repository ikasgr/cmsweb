            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nama_subsubmenu" name="nama_subsubmenu" value="<?= esc($nama_subsubmenu) ?>" class="form-control">
                ...
                <div>
                    <div class="form-group mb-2" id="berita">
                        ...
                        <select name="dberita" id="dberita" class="form-select pointer">
                            ...
                            <?php foreach ($kategoriberita as $key => $data) { ?>
                                <option data-link_subsubmenu="category/<?= esc($data['slug_kategori']) ?>"><?= esc($data['nama_kategori']) ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group mb-2" id="halaman">
                        ...
                        <select name="dhalaman" id="dhalaman" class="form-select pointer">
                            ...
                            <?php foreach ($halaman as $key => $data) { ?>
                                <option data-link_subsubmenu="page/<?= esc($data['slug_berita']) ?>"><?= esc($data['judul_berita']) ?></option>
                            <?php } ?>
                        </select>
                        <div class="invalid-feedback errorKategori"></div>
                    </div>
                    ...
                    <div class="form-group mb-2" id="eksternal">
                        ...
                        <input type="text" id="link_subsubmenu" name="link_subsubmenu" value="<?= esc($link_subsubmenu) ?>" class="form-control">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="link_subsubmenuold" name="link_subsubmenuold" readonly value="<?= esc($link_subsubmenu) ?>" class="form-control">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" id="iconssm" name="iconssm" value="<?= esc($iconssm) ?>">
                    </div>
