                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane p-1" id="konten" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12 mb-3">
                                        <label> <i class="fas fa-bullhorn"></i> Tampilkan Running Text <small>* Data Pengumuman</small> </label>
                                        <div class="form-control p-0">
                                    ...
                                    <div class="form-group col-md-3 col-12 mb-3">
                                        <label> <i class="fas fa-user-plus"></i> Aktifkan <small>Registrasi</small> </label>
                                        <div class="form-control p-0">
                                    ...
                                    <div class="form-group col-md-3 col-12 mb-3">
                                        <label> <i class="fas fa-user-tag"></i> Role <small>User saat Daftar</small> </label>
                                    ...
                                    <div class="form-group col-md-3 col-12 mb-3">
                                        <label> <i class="fas fa-check-circle"></i> Verifikasi <small>Postingan</small> </label>
                                        <div class="form-control p-0">
                                    ...
                                    <div class="form-group col-md-6 col-12 mb-3">
                                        <label> <i class="fas fa-bell"></i> Tampilkan Popup <small>(Isi diatur di menu Set Konten)</small></label>
                                        <div class="form-control p-0">
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <label> <i class="fas fa-folder"></i> Kategori Berita </label> <small>* Data terpilih akan tampil di home </small>
                            ...
                            <div class="tab-pane p-1" id="setemail" role="tabpanel">
                                ...
                                <p>
                                <section>
                                    <h5 class="text-primary mb-2"><i class="fas fa-envelope"></i> Pengaturan Email Pemberitahuan</h5>
                                    <div class="alert alert-warning">
                                        <p class="mb-1 text-dark">
                                            Pastikan Akun Email SMTP Anda telah dikonfigurasi di hosting.
                                        </p>
                                        <small class="text-muted">
                                            Untuk SMTP Google, sesuaikan pengaturan dengan kebijakan Google yang dapat berubah sewaktu-waktu.
                                        </small>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-server"></i> Host SMTP <small>(isi sesuai nama domain/mail server)</small></label>
                                            <input type="text" id="mail_host" name="mail_host" value="<?= esc($mail_host) ?>" class="form-control" placeholder="Masukkan Host SMTP">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-email"></i> User SMTP <small>(alamat email SMTP)</small></label>
                                            <input type="text" id="mail_user" name="mail_user" value="<?= esc($mail_user) ?>" class="form-control" placeholder="Masukkan Email SMTP">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-lock"></i> Password SMTP <small>(password email SMTP)</small></label>
                                            <input type="password" id="smtp_pass" name="smtp_pass" value="<?= esc($smtp_pass) ?>" class="form-control" placeholder="Masukkan Password SMTP">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-numeric"></i> Port SMTP <small>(port email SMTP)</small></label>
                                            <input type="number" id="smtp_port" name="smtp_port" value="<?= esc($smtp_port) ?>" class="form-control" placeholder="Masukkan Port SMTP">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-message"></i> Balasan Pembuka</label>
                                            <input type="text" id="smtp_pesanbalas" name="smtp_pesanbalas" value="<?= esc($smtp_pesanbalas) ?>" class="form-control" placeholder="Isi pesan balasan pembuka" title="Pesan pembuka sebelum tanggapan dikirimkan ke penerima.">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-account"></i> Nama Pengirim <small>(nama pengirim yang diterima)</small></label>
                                            <input type="text" id="smtp_pengirim" name="smtp_pengirim" value="<?= esc($smtp_pengirim) ?>" class="form-control" placeholder="Masukkan Nama Pengirim">
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section class="mt-2">
                                    <h5 class="text-success"><i class="fab fa-whatsapp"></i> Pengaturan WhatsApp Pemberitahuan</h5>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" id="wa_token" name="wa_token" value="<?= esc($wa_token) ?>" class="form-control" placeholder="Masukkan API Key">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-link"></i> URL Server</label>
                                            <input type="text" id="urlserver" name="urlserver" value="<?= esc($urlserver) ?>" class="form-control" placeholder="Masukkan URL Server">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-whatsapp"></i> Nomor WhatsApp Terdaftar</label>
                                            <input type="text" id="wa_sender_number" name="wa_sender_number" value="<?= esc($wa_sender_number) ?>" class="form-control" placeholder="Masukkan Nomor WA Terdaftar" title="Nomor WA yang terdaftar di layanan WA Gateway">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label><i class="mdi mdi-whatsapp"></i> Nomor WhatsApp Penerima Pesan</label>
                                            <input type="text" id="wa_receiver" name="wa_receiver" value="<?= esc($wa_receiver) ?>" class="form-control" placeholder="Masukkan Nomor WA Penerima Pesan" title="Nomor WA penerima pesan ketika ada masukan saran yang masuk.">
                                        </div>
                                    </div>
                                </section>
                            </div>
                            ...
                            <div class="tab-pane p-1" id="utility" role="tabpanel">
                                ...
                                <section class="mb-4">
                                    ...
                                    <div class="alert alert-primary alert-dismissible fade show mb-2" role="alert">
                                        ...
                                        <p class="mb-0">Ganti URL login untuk meningkatkan keamanan. Pastikan mudah diingat dan aman.</p>
                                        <small class="text-danger" style="margin-top: -1px;">Ganti URL login secara berkala untuk mencegah akses bot atau peretas.</small>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="login_alias" name="login_alias" value="<?= esc($login_alias) ?>" placeholder="Masukkan alias login Anda" required>
                                        </div>
                                        <div class="invalid-feedback errorlogin_alias"></div>
                                    </div>

                                    <div class="form-group mt-3">
                                        <label for="otp_akses">Aktifkan One-Time Password <small>(OTP) LOGIN</small></label>
                                        <div class="form-control p-0 d-flex gap-1">
                                            &nbsp; <input type="radio" name="otp_akses" id="otp_akses1" value="1" <?= $otp_akses == '1' ? 'checked' : '' ?>> <label for="otp_akses1" class="pointer pt-2"> Ya &nbsp</label>
                                            <input type="radio" name="otp_akses" id="otp_akses2" value="0" <?= $otp_akses == '0' ? 'checked' : '' ?>> <label for="otp_akses2" class="pointer pt-2"> Tidak &nbsp</label>
                                ...
                                <section class="mb-4">
                                    <h6 class="text-dark mb-2"><i class="fas fa-shield-alt"></i> Google reCAPTCHA V2</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="g_sitekey">Site Key <small><a href="https://www.google.com/recaptcha/admin/create" target="_blank" class="text-primary">(Daftar)</a></small></label>
                                                <input type="text" id="g_sitekey" name="g_sitekey" value="<?= esc($g_sitekey) ?>" class="form-control" placeholder="Masukkan Site Key">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="alert alert-info mb-3">
                                        <ul class="list-unstyled mb-2" style="font-size: 13px;">
                                            <li class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0">Lakukan pencadangan data secara berkala dan simpan di lokasi aman di luar server utama.</p>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <i class="fas fa-redo text-warning me-2"></i>
                                                <p class="mb-0">Hapus salinan pencadangan lama sebelum membuat cadangan baru untuk mengoptimalkan ruang penyimpanan.</p>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <i class="fas fa-exclamation-triangle text-danger me-2"></i>
                                                <p class="mb-0">Pastikan file cadangan <strong>DIHAPUS</strong> dari server setelah diunduh untuk mencegah potensi ancaman keamanan.</p>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <?php if (file_exists('public/file/db/' . $fileName)) { ?>
                                                <button type="button" class="btn btn-success btn-sm px-3 py-1 me-2" onclick="location.href=('<?= base_url('public/file/db/' . $fileName); ?>')">
                                                    <i class="fas fa-cloud-download-alt"></i> Download Db <?= $fileName ?>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm px-3 py-1" onclick="hapus('<?= $fileName ?>')">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="progress mt-2" style="height: 18px; display: none;" id="progress-container">
                                                    <div id="file-progress-bar" class="progress-bar bg-primary progress-bar-striped progress-bar-animated" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="form-group text-center">
                            <?php if ($is_maintenance == 1) { ?>
                                <button type="button" class="btn btn-danger btn-sm px-4 py-2" onclick="aktifkan('<?= $is_maintenance ?>')">
                                    <i class="fas fa-power-off"></i> Nonaktifkan Mode Maintenance
                                </button>
                            <?php } else { ?>
                                <button type="button" class="btn btn-warning btn-sm px-4 py-2" onclick="aktifkan('<?= $is_maintenance ?>')">
                                    <i class="fas fa-power-off"></i> Aktifkan Mode Maintenance
                                </button>
                            <?php } ?>
                            <small class="d-block mt-3">
                                <span class="text-muted"><?= $is_maintenance == 1 ? '<i class="fas fa-lock"></i> Situs hanya dapat diakses oleh Super Administrator.' : '<i class="fas fa-unlock"></i> Situs dapat diakses oleh semua pengguna.' ?></span>
                            </small>
                        </div>
                ...
                <div class="card mb-4 ">
                    <div class="card-body p-3">
                        ...
                        <small class="text-muted d-block mt-0">
                            <i>
                                Ukuran logo akan secara otomatis <span class="text-danger">dipotong (crop)</span> dengan tinggi
                                <b class="text-primary"><?= esc($hplogo) ?></b> piksel dan lebar <b class="text-primary"><?= esc($wllogo) ?></b> piksel. <br>
                                Jika Anda ingin mengubah ukuran ini, silahkan atur melalui menu template pilih Frontend tema <b><a href="<?= base_url('template/front') ?>" class="text-decoration-underline text-primary"><?= esc($temaaktif) ?></a></b>.
                            </i>
                        </small>
                    </div>
                </div>
