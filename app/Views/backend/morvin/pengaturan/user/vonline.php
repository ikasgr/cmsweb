                ...
                if ($data['urlmenu'] == 'user') { ?>
                    ...
                    <div class="card-body ">
                                            ...
                                            <a href="#">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body overflow-hidden">
                                                        <h5 class="text-truncate font-size-14 mb-1"><?= esc($data['fullname']) ?> <small class="text-danger">(<?= $namagrup ?>)</small></h5>
                        ...
                        <div class="text-center border-top pt-2">
                            ...
                            <button type="button" id="resetStatus" class="btn btn-warning btn-sm waves-effect waves-light refresh" title="Klik disini untuk OFFkan status Online bila pengguna keluar tanpa Logoff.">
                                <i class="mdi mdi-account-convert text-light"></i> Reset
                            </button>


                            <?php if ($sessionFilesCount > 10) { ?>
                                <button type="button" id="hapusSession" data-dir="./writable/session/" class="btn btn-danger btn-sm waves-effect waves-light delfile" title="Klik disini untuk hapus file session.">
                            ...
                            <?php if ($logFilesCount > 10) { ?>
                                <button id="hapusLogs" title="Klik disini untuk hapus file logs." class="btn btn-danger btn-sm waves-effect waves-light" data-dir="./writable/logs/" data-timelimit="10"><i class="mdi mdi-delete-sweep text-light"></i> <?= $logFilesCount ?> Logs</button>
                            <?php } else {  ?>
                                <button title="Jumlah file logs." class="btn btn-info btn-sm waves-effect waves-light"> <i class="mdi mdi-file-clock"></i> <?= $logFilesCount ?> Logs</button>
                            <?php } ?>
                        ...
                        <li class="">
                            <a href="<?= base_url('akun') ?>">
                                <div class="media">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        <h5 class="text-truncate font-size-14 mb-1"> <?= esc($list['fullname']) ?> <small class="text-danger">(<?= $role ?>)</small></h5>
                                        <p class="text-truncate mb-0 font-size-12"><?= $lastlogin ?></p>
                                    </div>
