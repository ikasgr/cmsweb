            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <div class="">
                            <input type="password" class="form-control" name="password" id="password" autocomplete="new-password" onkeyup="checkPasswordStrength(this.value)" value="" placeholder="Password" required>
