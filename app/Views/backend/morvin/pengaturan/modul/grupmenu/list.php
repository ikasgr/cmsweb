        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="p-1">&nbsp;<i class="<?= esc($data['ikonmn']) ?>"></i> <a class="text-primary" href="<?= base_url('submodul/' . $data['gm']) ?>"><?= esc($data['modul']) ?><a class="text-danger" title="Jumlah Submenu"> (<?= esc($jumgm['gm']) ?>)</a></a></td>
