                        ...
                        ?>
                            <tr>
                                <?php if ($p['type'] == 'Jawaban') { ?>
                                    <td width="200"><?= esc($p['pilihan']) ?> <a class="text-danger">(<code><?= $p['rating'] ?></code>)</td>
                                    <td>
                                        <div class="progress p-0" style="height: 20px;">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated p-0 pointer" title="<?= $prosentase ?> %" role="progressbar" style="width: <?= $prosentase ?>%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"><?= $prosentase ?>%</div>
                                        </div>
                                    </td>
                            </tr>
                        <?php } else { ?>
