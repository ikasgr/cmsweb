        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <table class="table table-hover p-0 pt-0">
                        <tbody>
                            <?php foreach ($poljawab as $p) : ?>
                                ...
                                ?>
                                <tr>
                                    <td width="200"><?= esc($p['pilihan']) ?> <a class="text-danger">(<code><?= $p['rating'] ?></code>)</a></td>
                                    <td>
                                        <div class="progress  p-0" style="height: 20px;">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated p-0 pointer" title="<?= $prosentase ?>%" role="progressbar" style="width: <?= $prosentase ?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><?= $prosentase ?>%</div>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <?php else : ?>
                    ...
                    <input type="hidden" class="form-control" id="informasi_id" value="<?= $informasi_id ?>" name="informasi_id">
                    <?php foreach ($poljawab as $p) : ?>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="poling_id" id="radpol<?= $p['poling_id'] ?>" value="<?= $p['poling_id'] ?>">
