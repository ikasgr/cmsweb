            ...
            <tbody>
                ...
                foreach ($list as $value) :
                    ...
                    <tr>
                        ...
                        <td class="p-1"><img class="img-circle elevation-2" src="<?= base_url('/public/img/galeri/foto/' . esc($value['gambar'])) ?>" width="100px" height="50px"></td>
                        ...
                        <td class="text-center ">
                            ...
                            <?php if ($hapus == 1) { ?>
                                <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1" onclick="hapus('<?= $value['foto_id'] ?>','<?= esc($value['judul']) ?>')">
