    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control" id="id_masterdata" value="<?= $id_masterdata ?>"
                    name="id_masterdata" readonly>
                <input type="hidden" class="form-control" id="req" value="<?= $req ?>" name="req" readonly>

                <div class="row">
                    <div class="form-group mb-2">
                        <label><?= esc($jdl) ?> </label>
                        <input type="text" class="form-control" id="nama_master" value="<?= esc($nama_master) ?>"
                            name="nama_master">
