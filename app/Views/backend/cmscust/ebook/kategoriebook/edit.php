    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control" id="kategoriebook_id" value="<?= $kategoriebook_id ?>"
                    name="kategoriebook_id" readonly>
                <div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label">Kategori</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="kategoriebook_nama"
                            value="<?= esc($kategoriebook_nama) ?>" name="kategoriebook_nama">
