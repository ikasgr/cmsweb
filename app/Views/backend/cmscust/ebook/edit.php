            ...
            <div class="modal-body">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <select name="kategoriebook_id" id="kategoriebook_id" class="form-select pointer">
                            ...
                            <?php foreach ($kategoriebook as $key => $value) { ?>
                                <option value="<?= $value['kategoriebook_id'] ?>"
                                    <?= $kategoriebook_id == $value['kategoriebook_id'] ? 'selected' : '' ?>>
                                    <?= esc($value['kategoriebook_nama']) ?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <label class="form-control"><a target='_BLANK'
                                href="<?= base_url('public/deploy/pdf/' . esc($fileebook)) ?>"><i
                                    class="far fa-file-pdf text-danger"></i> <?= esc($fileebook) ?></a></label>
                    </div>
                </div>
            </div>
