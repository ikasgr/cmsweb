        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-sm table-hover table-striped p-0">
                    ...
                    <tr>
                        <th width="160" rowspan="8"> <img src="<?= base_url('/public/img/ebook/' . esc($gambar)) ?>"
                                alt="Cover" width="100%"></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="p-1">:</td>
                        <td class="p-1"> <a class="text-primary" href="<?= base_url('bacabuku/' . esc($fileebook)) ?>"
                                target="_blank"><span class="text-primary" title="Klik disini untuk mulai baca"
                                    style="font-size:13px"> Baca Buku &raquo;</span></a></td>
                    </tr>
