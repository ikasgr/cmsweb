        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_lengkap_suami" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_suami" class="form-control" rows="2"
                        placeholder="Alamat lengkap suami"></textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_istri" class="form-control" rows="2"
                        placeholder="Alamat lengkap istri"></textarea>
