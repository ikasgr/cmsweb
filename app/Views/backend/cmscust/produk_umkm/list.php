...
<div class="table-responsive mt-3">
    <table id="listproduk" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="<?= base_url('/public/img/produk/' . $data['gambar']) ?>" class="img-thumbnail"
                                alt="<?= esc($data['nama_produk']) ?>" style="width: 60px; height: 60px; object-fit: cover;">
                        </td>
                        <td>
