...
<?= $this->section('script') ?>
<script
    src="<?= base_url('public/template/backend/assets/libs/datatables.net/js/jquery.dataTables.min.js') ?>"></script>
<script
    src="<?= base_url('public/template/backend/assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js') ?>"></script>
<?= $this->endSection() ?>