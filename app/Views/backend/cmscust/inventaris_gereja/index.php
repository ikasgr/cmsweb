                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="auto-generate-kode"
                                            checked>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="auto-generate-qr"
                                            checked>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="maintenance-alert-days" value="30"
                                        min="1" max="90">
                                </div>
                            </div>
                            <div class="col-md-6">
