        ...
        <tbody>
            ...
            foreach ($list as $data):
                ...
                <tr>
                    ...
                    <td class="text-center p-1"><img class="img-circle elevation-2 pointer" title="Ganti Gambar"
                            onclick="gantifoto('<?= $data['id_link'] ?>')"
                            src="<?= base_url('public/img/linkterkait/' . esc($data['gambar'])) ?>" width="50px"></td>
                    ...
                    <td class="text-center p-1">
                        ...
                        <?php if ($ubah == 1) { ?>
                            <button type="button" onclick="toggle('<?= $data['id_link'] ?>', '<?= $jtogel1 ?>')"
                                class=" btn btn-circle btn-sm <?= $btnToggleClass ?>" title="<?= $toggleTitle ?>">
                                <i class="nav-icon <?= $toggleIcon ?>"></i>
                            </button>
                            <button type="button" onclick="toggle('<?= $data['id_link'] ?>', '<?= $jtogel2 ?>')"
                                class=" btn btn-circle btn-sm <?= $btnToggleClass2 ?>" title="<?= $toggleTitle2 ?>">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['id_link'] ?>','<?= esc($data['nama_link']) ?>')">
