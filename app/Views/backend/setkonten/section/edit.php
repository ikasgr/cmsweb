            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12 mb-2">
                        ...
                        <input type="text" id="nama_section" name="nama_section" value="<?= esc($nama_section) ?>"
                            class="form-control ">
                ...
                <div class="form-group mb-2">
                    ...
                    <label><i class="mdi mdi-clipboard-check-outline"></i> Sumber Link</label> <small
                        class="text-danger"> (Pilih jika Link mau diganti) </small>
                ...
                <!-- Single menu start -->
                <input type="hidden" id="linksumber" name="linksumber" value="<?= esc($linksumber) ?>"
                    class="form-control ">
                <div id="single">
                ...
                <center>
                    <img class="img-thumbnailx" id="img_load"
                        src="<?= base_url('public/img/section/' . esc($gambar)) ?>" height="100" alt="Section">
