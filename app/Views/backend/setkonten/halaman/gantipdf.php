            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <li> Format file: <small class="text-danger">.pdf</small> file ini akan disematkan ke halaman.
                        </li>
                    ...
                    <?php if (esc($filepdf) != '') { ?>
                        ...
                        <div class="form-group">
                            ...
                            <label><a target='_BLANK'
                                    href="<?= base_url('public/img/informasi/pdf/' . esc($filepdf)) ?>"><?= esc($filepdf) ?></a></label>
                        </div>
