    ...
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            ...
            <center>
                ...
                <?php if (esc($gambar) != 'default.png') { ?>
                    <img class="img-thumbnail" id="img_load"
                        src="<?= base_url('public/img/informasi/profil/' . esc($gambar)) ?>" alt="Sampul Profil">
                <?php } else { ?>
                    <img class="img-thumbnail" id="img_load"
                        src="<?= base_url('public/img/informasi/profil/default.png') ?>" alt="Sampul Profil">
                <?php } ?>
            </center>
