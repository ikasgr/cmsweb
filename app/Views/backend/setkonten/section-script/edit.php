            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-7 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" value="<?= esc($nama_section) ?>" id="nama_section"
                            name="nama_section">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea type="text" class="form-control " id="isi_script"
                        name="isi_script"><?= ($isi_script) ?></textarea>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 col-12 mb-2">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btnupload"><i
