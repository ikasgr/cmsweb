...
<?php } ?>
<small class="text-secondary"> Ukuran iklan diatur sendiri sesuai template yang digunakan. Ukuran yang digunakan untuk
    beranda tengah <strong class="text-primary"> 1280x210px</strong></small>
<hr>
        ...
        <tbody>
            ...
            foreach ($list as $value):
                ...
                <tr>
                    ...
                    <td class="p-1">
                        <?php if ($ubah == 1) { ?>
                            <img class="img-circle elevation-2 pointer" onclick="gantibanner('<?= $value['id_banner'] ?>')"
                                title="Ganti banner" src="<?= base_url('/public/img/banner/' . esc($value['banner_image'])) ?>"
                                width="100" height="40">
                        <?php } else { ?>
                            <img class="img-circle elevation-2"
                                src="<?= base_url('/public/img/banner/' . esc($value['banner_image'])) ?>" width="100">
                        <?php } ?>
                    </td>
