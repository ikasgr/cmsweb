            ...
            foreach ($list as $data):
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($ubah == 1) { ?>
                            <img class="img-circle elevation-2 pointer p-0"
                                onclick="gantifoto('<?= $data['kategorifoto_id'] ?>')"
                                src="<?= base_url('public/img/galeri/katfoto/' . esc($data['cover_foto'])) ?>"
                                title="Ganti Cover" width="60px">
                        <?php } else { ?>
                            <img class="img-circle elevation-2 p-0"
                                src="<?= base_url('public/img/galeri/katfoto/' . esc($data['cover_foto'])) ?>" width="60px">

                        <?php } ?>
                    </td>

                    <td class="">
                        <a class="text-primary" href="<?= base_url('foto/det/' . $data['kategorifoto_id']) ?>"
                            title="Detail Foto"> <?= esc($data['nama_kategori_foto']) ?></a>
                    ...
                    <td class="text-center ">
                        <?php if ($ubah == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['kategorifoto_id'] ?>')">
                        ...
                        <?php if ($jfoto == 0 && $hapus == 1) { ?>
                            <button type="button" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['kategorifoto_id'] ?>')">
