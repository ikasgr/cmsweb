    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control" id="kategorifoto_id" value="<?= $kategorifoto_id ?>"
                    name="kategorifoto_id" readonly>
                <div class="form-group mb-2">
                    <label>Kategori</label>
                    <input type="text" class="form-control" id="nama_kategori_foto"
                        value="<?= esc($nama_kategori_foto) ?>" name="nama_kategori_foto">
                ...
                <div class="form-group " id="tglalbum">
                    ...
                    <input type="text" class="form-control" id="tgl_album" name="tgl_album"
                        value="<?= shortdate_indo($tgl_album) ?>" data-date-format="dd M, yyyy"
                        data-date-container='#tglalbum' data-provide="datepicker" data-date-autoclose="true">
