...
<table class="table table-hover tambahform">
    ...
    <tbody>
        <tr>
            ...
            <td class="pb-0 pt-1 p-2">
                <button type="button" class="btn btn-primary waves-effect waves-light tambahelemen p-2"><i
...
<div class="modal-footer">
    <td>
        <button type="button" class="btn btn-primary btnupload2"><i class="mdi mdi-content-save-all"></i> Simpan
            Data</button>
