...
<table class="table table-hover tambahform">
    ...
    <tbody>
        <tr>
            ...
            <td class="pb-0 pt-1 p-2">
                <input type="text" class="form-control" required id="video_link" name="video_link[]"
                    placeholder="X_fh-xVmto0">
                <div class="invalid-feedback errorvideo_link">
            </td>

            <td class="pb-0 pt-1 p-2">
                <button type="button" class="btn btn-primary tambahelemen p-2"><i
...
<div class="modal-footer">
    <td>
        <button type="button" class="btn btn-primary btnupload2"><i class="mdi mdi-content-save-all"></i>
            Simpan</button>
