        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea type="text" rows="2" id="ket_video" name="ket_video"
                        class="form-control"><?= esc($ket_video) ?></textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="video_link" name="video_link" value="<?= esc($video_link) ?>"
                        class="form-control">
