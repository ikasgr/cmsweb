    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" class="form-control" id="kategorivideo_id" value="<?= $kategorivideo_id ?>"
                    name="kategorivideo_id" readonly>
                <div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label">Kategori</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama_kategori_video"
                            value="<?= esc($nama_kategori_video) ?>" name="nama_kategori_video">
