<a href="<?= base_url('video/all') ?>" class="btn btn-warning btn-sm "><i
                    ...
                    <td class="text-center p-1">
                        <?php if ($ubah == 1) { ?>
                            <button type="button" title="Edit Data" class="btn btn-light btn-sm p-1"
                                onclick="edit('<?= $data['kategorivideo_id'] ?>')">
                        ...
                        <?php if ($hapus == 1) { ?>
                            <button type="button" title="Hapus Data" class="btn btn-light btn-sm p-1"
                                onclick="hapus('<?= $data['kategorivideo_id'] ?>','<?= esc($data['nama_kategori_video']) ?>')">
