...
class Unitkerja extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('backend/' . esc($tadmin['folder']) . '/' . 'setkonten/unitkerja/index', $data);
    }
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($listgrupf) {
                ...
                if ($akses == '1' || $akses == '2') {
                    ...
                    $msg = [
                        'data' => view('backend/' . esc($tadmin['folder']) . '/' . 'setkonten/unitkerja/list', $data)
                    ];
                } else {
                    $msg = [
                        'noakses' => []
    ...
    public function formtambah()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data'  => view('backend/' . esc($tadmin['folder']) . '/' . 'setkonten/unitkerja/tambah', $data)
            ];
            echo json_encode($msg);
        }
    }
    ...
    public function tipe()
    {
        ...
        return view('backend/' . esc($tadmin['folder']) . '/' . 'setkonten/unitkerja/tipe/index', $data);
    }
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($listgrupf) {
                ...
                if ($akses == '1' || $akses == '2') {
                    ...
                    $msg = [
                        'data' => view('backend/' . esc($tadmin['folder']) . '/' . 'setkonten/unitkerja/tipe/list', $data)
                    ];
                } else {
                    $msg = [
                        'noakses' => []
    ...
    public function formtipe()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('backend/' . esc($tadmin['folder']) . '/' . 'setkonten/unitkerja/tipe/tambah', $data)
            ];
            echo json_encode($msg);
        }
    }
