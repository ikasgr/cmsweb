...
class Transparansi extends BaseController
{
	public function index()
	{
		...
		return view('frontend/transparansi/index', $data);
	}
	...
	function TampilkanGrafik()
	{
		...
		$dgrafik = [
			'data' => view('backend/' . 'lembaga/transparansi/vgrafik', $data),
	...
	public function list()
	{
		...
		return view('backend/' . 'lembaga/transparansi/index', $data);
	}
	...
	public function getdata()
	{
		...
		echo json_encode([
			'data' => view('backend/lembaga/transparansi/list', $data),
		]);
	}
	...
	public function formtambah()
	{
		...
		if ($this->request->isAJAX()) {
			...
			$msg = [
				'data' => view('backend/' . 'lembaga/transparansi/tambah', $data)
	...
	public function formedit()
	{
		...
		if ($this->request->isAJAX()) {
			...
			$msg = [
				'sukses' => view('backend/' . 'lembaga/transparansi/edit', $data),
				'csrf_tokencmsikasmedia' => csrf_hash(),
			];
			echo json_encode($msg);
		}
	...
	public function detail($transparan_id = null)
	{
		...
		return view('backend/' . 'lembaga/transparansi/detail/index', $data);
	}
		...
		if ($this->request->isAJAX()) {
			...
			if ($listgrupf) {
				...
				if ($akses == '1' || $akses == '2') {
					...
					$msg = [
						'data' => view('backend/lembaga/transparansi/detail/list', $data),
					];
	...
	public function formtambahsubproduk()
	{
		...
		if ($this->request->isAJAX()) {
			...
			$msg = [
				'data' => view('backend/' . 'lembaga/transparansi/detail/tambah', $data)
	...
	public function formeditdetail()
	{
		...
		if ($this->request->isAJAX()) {
			...
			$msg = [
				'sukses' => view('backend/' . 'lembaga/transparansi/detail/edit', $data),
				'csrf_tokencmsikasmedia' => csrf_hash(),
			];
			echo json_encode($msg);
		}
