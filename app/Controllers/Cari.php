        ...
        if ($keywordcari || $kategori) {
            ...
            if (0) {
                ...
                if ($agent->isMobile()) {
                    ...
                    return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/semua_berita', $data);
                }
            } else {
                return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/semua_berita', $data);
            }
        ...
        if ($keywordcari || $kategori) {
            ...
            if (0) {
                ...
                if ($agent->isMobile()) {
                    ...
                    return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/v_hasilcarivideo', $data);
                }
            } else {
                return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/v_hasilcarivideo', $data);
            }
            ...
            if (0) {
                ...
                if ($agent->isMobile()) {
                    ...
                    return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/semua_video', $data);
                }
            } else {
                return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/semua_video', $data);
            }
        ...
        if ($keywordcari || $kategori) {
            ...
            if (0) {
                ...
                if ($agent->isMobile()) {
                    ...
                    return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/v_hasilcaribuku', $data);
                }
            } else {
                return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/v_hasilcaribuku', $data);
            }
            ...
            if (0) {
                ...
                if ($agent->isMobile()) {
                    ...
                    return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/semua_ebook', $data);
                }
            } else {
                return view('frontend/' . esc($template['folder']) . '/desktop/' . 'content/semua_ebook', $data);
            }
