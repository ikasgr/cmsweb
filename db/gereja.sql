-- Adminer 5.3.0 MariaDB 10.5.6-MariaDB-log dump
...
(16,	'Peluncuran Program Karunia dan Pemberdayaan Masyarakat GMIT Flobamora Ver. 2.0',	'peluncuran-program-karunia-dan-pemberdayaan-masyarakat-gmit-flobamora-ver-20',	'default.png',	'<p style=\"line-height: 1.8;\"><span style=\"font-size: 18px;\">Berbagai perbaikan dan penyempurnaan program diaconia dan diakonia gereja GMIT Flobamora terus dilakukan agar jemaat dan masyarakat sekitar yang sudah mempercayakan pelayanan gereja mendapatkan layanan yang maksimal. Untuk itu program yang awalnya dikembangkan tahun 2021 ini, terus berbenah. Hal ini ditandai dengan diluncurkannya Program Karunia dan Pemberdayaan Masyarakat Versi 2.0 pada tanggal 17 Agustus 2023 mendatang untuk memperingati hari kemerdekaan dan semangat penginjilan gereja.&nbsp;</span></p>',	'Aula Gereja GMIT Flobamora',	'Panitia Program GMIT',	'2023-08-02',	'2023-08-17',	'2023-08-02',	'08.00 - Selesai',	40,	1,	NULL),
(17,	'Launching Platform Penginjilan Digital GMIT Flobamora',	'launching-platform-penginjilan-digital-gmit-flobamora',	'default.png',	'  <p>Akan dilakukan launching platform penginjilan digital terbaru dengan fitur pemberitaan injil dan komunitas jemaat online</p>',	'Gereja GMIT Flobamora',	'Panitia IT GMIT',	'2023-10-29',	'2023-10-29',	'2024-06-23',	'08',	29,	1,	NULL),
(19,	'Launching Portal Informasi Jemaat GMIT Flobamora',	'launching-portal-informasi-jemaat-gmit-flobamora',	'default.png',	'     <p>Pembaruan portal informasi jemaat dengan tampilan tema yang diperindah dan penyajian informasi ibadah serta kegiatan gereja yang lebih elegan dan komprehensif.</p>',	'Gedung Gereja GMIT Flobamora',	'Divisi Komunikasi',	'2025-02-06',	'2025-02-06',	'2025-02-05',	'08.00 WITA - Selesai',	24,	1,	NULL);
...
(1,	'Rencana dan Program Kerja Pemberdayaan Jemaat GMIT Flobamora',	'1624787922_9110c06de6b051bd2a4a.txt',	'rencana-dan-program-kerja-pemberdayaan-jemaat-gmit-flobamora',	'2021-06-04',	18,	1,	NULL,	NULL),
(2,	'Visi Misi dan Nilai-nilai Kristus GMIT Flobamora',	'1629372547_de2ea6f345b7e33bb086.png',	'visi-misi-dan-nilai-nilai-kristus-gmit-flobamora',	'2021-06-04',	25,	1,	NULL,	NULL),
(3,	'Laporan Hasil Pelaksanaan Program Pelayanan dan Penginjilan GMIT Flobamora',	'1689768228_d346a58433ac8b0c0d4a.xlsx',	'laporan-hasil-pelaksanaan-program-pelayanan-dan-penginjilan-gmit-flobamora',	'2021-06-04',	26,	1,	NULL,	NULL);
...
DROP TABLE IF EXISTS `bt_bidang`;
...
DROP TABLE IF EXISTS `bt_bukutamu`;
...
TRUNCATE `bt_bukutamu`;

DROP TABLE IF EXISTS `bt_jenispendataanjemaat`;
...
TRUNCATE `bt_jenispendataanjemaat`;
INSERT INTO `bt_jenispendataanjemaat` (`bidang_id`, `nama_bidang`) VALUES
(4,	'BAPTIS'),
(6,	'SIDI'),
(7,	'NIKAH');

DROP TABLE IF EXISTS `bt_pendataanjemaat`;
...
TRUNCATE `bt_pendataanjemaat`;

DROP TABLE IF EXISTS `cms__grupakses`;
...
DROP TABLE IF EXISTS `cms__modul`;
...
(31,	'Pengguna',	1,	2,	1,	0,	'Pengaturan',	'sm',	'user',	'fas fa-ad'),
...
DROP TABLE IF EXISTS `cms__usersessions`;
...
TRUNCATE `custome__absensi_majelis`;

DROP TABLE IF EXISTS `custome__anggota`;
...
TRUNCATE `custome__anggota`;

DROP TABLE IF EXISTS `custome__anggota_keluarga`;
...
TRUNCATE `custome__anggota_keluarga`;

DROP TABLE IF EXISTS `custome__aset_gereja`;
...
TRUNCATE `custome__aset_gereja`;
INSERT INTO `custome__aset_gereja` (`id_aset`, `kode_aset`, `nama_aset`, `id_kategori`, `id_lokasi`, `merk`, `model`, `serial_number`, `tahun_pembuatan`, `tanggal_pembelian`, `harga_perolehan`, `nilai_residu`, `masa_pakai`, `metode_depreciation`, `nilai_buku`, `akumulasi_depreciation`, `supplier`, `no_faktur`, `warranty_start`, `warranty_end`, `insurance_company`, `insurance_policy`, `insurance_value`, `kondisi`, `status`, `qr_code`, `barcode`, `foto_aset`, `spesifikasi`, `keterangan`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1,	'AST001',	'Kursi Jemaat Kayu Jati',	1,	2,	'Furniture Indah',	'FI-KJ-001',	'FI001-100',	'2024',	'2024-01-15',	15000000.00,	1500000.00,	10,	'Straight Line',	0.00,	0.00,	'Furniture Indah',	'INV-2024-001',	'2024-01-15',	'2025-01-15',	NULL,	NULL,	0.00,	'Baik',	'Aktif',	NULL,	NULL,	NULL,	'100 unit kursi kayu jati dengan bantalan',	'Kursi untuk jemaat di ruang ibadah utama',	NULL,	NULL,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(2,	'AST002',	'Sound System Yamaha',	6,	2,	'Yamaha',	'MG16XU',	'YMH-2024-001',	'2024',	'2024-02-10',	25000000.00,	2500000.00,	7,	'Straight Line',	0.00,	0.00,	'CV Mitra Elektronik',	'INV-2024-002',	'2024-02-10',	'2026-02-10',	NULL,	NULL,	0.00,	'Baik',	'Aktif',	NULL,	NULL,	NULL,	'Mixer 16 channel dengan USB interface',	'Sound system utama untuk ibadah',	NULL,	NULL,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(3,	'AST003',	'Laptop Dell Inspiron',	5,	4,	'Dell',	'Inspiron 15 3000',	'DL123456789',	'2024',	'2024-03-05',	8500000.00,	850000.00,	4,	'Straight Line',	0.00,	0.00,	'CV Mitra Elektronik',	'INV-2024-003',	'2024-03-05',	'2025-03-05',	NULL,	NULL,	0.00,	'Baik',	'Aktif',	NULL,	NULL,	NULL,	'Intel i5, 8GB RAM, 512GB SSD',	'Laptop untuk administrasi kantor',	NULL,	NULL,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(4,	'AST004',	'Meja Kantor Minimalis',	1,	4,	'Furniture Indah',	'FI-MK-002',	'FI002-005',	'2024',	'2024-01-20',	3500000.00,	350000.00,	10,	'Straight Line',	0.00,	0.00,	'Furniture Indah',	'INV-2024-004',	'2024-01-20',	'2025-01-20',	NULL,	NULL,	0.00,	'Baik',	'Aktif',	NULL,	NULL,	NULL,	'5 unit meja kantor dengan laci',	'Meja untuk staff administrasi',	NULL,	NULL,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(5,	'AST005',	'Proyektor Epson',	2,	2,	'Epson',	'EB-X41',	'EPS-2024-001',	'2024',	'2024-04-12',	6500000.00,	650000.00,	5,	'Straight Line',	0.00,	0.00,	'CV Mitra Elektronik',	'INV-2024-005',	'2024-04-12',	'2025-04-12',	NULL,	NULL,	0.00,	'Baik',	'Aktif',	NULL,	NULL,	NULL,	'3600 lumens, XGA resolution',	'Proyektor untuk presentasi ibadah',	NULL,	NULL,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08');

DROP TABLE IF EXISTS `custome__barang`;
...
TRUNCATE `custome__barang`;
INSERT INTO `custome__barang` (`id_barang`, `nama_barang`, `harga`, `tgl_berlaku`, `status`, `gambar`) VALUES
(1,	'Ikan Asin Sekali',	32322,	'2022-06-21',	'1',	'1655821424_8b171513a67e20dd59a1.jpeg'),
(3,	'Kwatek Lamalera',	23311,	'2022-06-21',	'1',	'1655811548_2303238680c7cff27dbc.jpg'),
(4,	'Minyak Goreng Kemasan',	14000,	'2022-06-21',	'1',	'1655817838_b1ba9bd4b5f797f33994.png'),
(5,	'Tepung Terigu Protein Rendah',	8500,	'2022-06-21',	'1',	'1655817998_03d1bb5243f94d9b0fc6.jpg'),
(6,	'Telur Ayam Ras',	28800,	'2022-06-21',	'1',	'1655821530_abe541da57a03963380a.jpg'),
(7,	'Kacang Tanah',	29500,	'2022-06-21',	'1',	'1655821681_cb4f8acd8beb593a808a.jpg');

DROP TABLE IF EXISTS `custome__depreciation_aset`;
...
TRUNCATE `custome__depreciation_aset`;

DROP TABLE IF EXISTS `custome__detlapak`;
...
TRUNCATE `custome__detlapak`;
INSERT INTO `custome__detlapak` (`id_detlapak`, `id_lapak`, `deskripsi`, `gambar`, `status`) VALUES
(3,	9,	'Tampilan Awal',	'1656593492_e2dff5a7ddb2275489cc.jpg',	'1'),
(4,	9,	'Tampilan kedua',	'1656593493_a70df1ef04ae81f78c61.jpg',	'1'),
(5,	11,	'Ini detail author ikan',	'1656658503_496581683c700efe0869.jpeg',	'1'),
(6,	11,	'Detaiil 2 sapi',	'1656658503_38821fac31c55eac124b.jpg',	'1');
...
TRUNCATE `custome__jabatan_majelis`;
INSERT INTO `custome__jabatan_majelis` (`jabatan_id`, `nama_jabatan`, `deskripsi`, `tingkatan`, `status`, `created_at`, `updated_at`) VALUES
(1,	'Ketua Majelis',	'Ketua Majelis Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(2,	'Wakil Ketua Majelis',	'Wakil Ketua Majelis Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(3,	'Sekretaris Majelis',	'Sekretaris Majelis Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(4,	'Bendahara Majelis',	'Bendahara Majelis Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(5,	'Anggota Majelis',	'Anggota Majelis Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(6,	'Pendeta',	'Pendeta Jemaat',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(7,	'Pendeta Pembantu',	'Pendeta Pembantu',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(8,	'Diakon',	'Diakon Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(9,	'Pelayan Firman',	'Pelayan Firman',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(10,	'Pemusik',	'Pemusik Gereja',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(11,	'Pelayan Multimedia',	'Pelayan Multimedia',	'Lokal',	'Aktif',	'2025-12-28 16:04:15',	'2025-12-28 16:04:15');

DROP TABLE IF EXISTS `custome__jabatan_pelayanan`;
...
TRUNCATE `custome__jabatan_pelayanan`;
INSERT INTO `custome__jabatan_pelayanan` (`id_jabatan`, `nama_jabatan`, `deskripsi`, `warna`, `urutan`, `status`, `created_at`, `updated_at`) VALUES
(1,	'Pendeta/Pengkhotbah',	'Memimpin ibadah dan menyampaikan khotbah',	'#dc3545',	1,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(2,	'Liturgis',	'Memimpin liturgi ibadah',	'#007bff',	2,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(3,	'Organis/Pianis',	'Memainkan musik pengiring',	'#28a745',	3,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(4,	'Pemimpin Pujian',	'Memimpin pujian dan penyembahan',	'#17a2b8',	4,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(5,	'Koor/Paduan Suara',	'Menyanyikan lagu khusus',	'#ffc107',	5,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(6,	'Lektor',	'Membaca firman Tuhan',	'#fd7e14',	6,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(7,	'Kolektan',	'Mengumpulkan persembahan',	'#6f42c1',	7,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(8,	'Usher/Penyambut',	'Menyambut dan mengarahkan jemaat',	'#20c997',	8,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(9,	'Operator Sound',	'Mengoperasikan sistem audio',	'#6c757d',	9,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(10,	'Operator Proyektor',	'Mengoperasikan proyektor/layar',	'#e83e8c',	10,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23');

DROP TABLE IF EXISTS `custome__jadwal_ibadah`;
...
TRUNCATE `custome__jadwal_ibadah`;
INSERT INTO `custome__jadwal_ibadah` (`id_jadwal`, `id_jenis_ibadah`, `judul_ibadah`, `tanggal`, `jam_mulai`, `jam_selesai`, `tempat`, `tema_ibadah`, `ayat_tema`, `liturgi`, `keterangan`, `max_peserta`, `is_recurring`, `recurring_type`, `recurring_end`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
(1,	1,	'Ibadah Minggu Pagi',	'2025-10-12',	'08:00:00',	'10:00:00',	'Gereja',	'Kasih yang Tidak Berkesudahan',	'Yohanes 3:16',	NULL,	NULL,	NULL,	0,	NULL,	NULL,	'Terjadwal',	NULL,	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(2,	1,	'Ibadah Minggu Pagi',	'2025-10-19',	'08:00:00',	'10:00:00',	'Gereja',	'Pengharapan dalam Kristus',	'Roma 15:13',	NULL,	NULL,	NULL,	0,	NULL,	NULL,	'Terjadwal',	NULL,	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(3,	2,	'Ibadah Minggu Sore',	'2025-10-12',	'17:00:00',	'18:30:00',	'Gereja',	'Bersyukur dalam Segala Hal',	'1 Tesalonika 5:18',	NULL,	NULL,	NULL,	0,	NULL,	NULL,	'Terjadwal',	NULL,	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(4,	3,	'Ibadah Rabu',	'2025-10-16',	'19:00:00',	'20:30:00',	'Gereja',	'Doa yang Berkuasa',	'Yakobus 5:16',	NULL,	NULL,	NULL,	0,	NULL,	NULL,	'Terjadwal',	NULL,	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(5,	4,	'Ibadah Jumat',	'2025-10-18',	'19:00:00',	'20:00:00',	'Gereja',	'Memuji Tuhan Senantiasa',	'Mazmur 34:1',	NULL,	NULL,	NULL,	0,	NULL,	NULL,	'Terjadwal',	NULL,	'2025-12-28 16:03:23',	'2025-12-28 16:03:23');

DROP TABLE IF EXISTS `custome__jadwal_pelayanan`;
...
TRUNCATE `custome__jadwal_pelayanan`;
INSERT INTO `custome__jadwal_pelayanan` (`id_jadwal`, `judul_jadwal`, `jenis_pelayanan`, `tanggal`, `waktu_mulai`, `waktu_selesai`, `tempat`, `pengkhotbah`, `liturgis`, `singer`, `pemusik`, `multimedia`, `usher`, `keterangan`, `status`, `warna`, `user_id`, `tgl_input`) VALUES
(1,	'Ibadah Minggu I',	'Ibadah Minggu',	'2025-12-29',	'07:00:00',	'09:00:00',	'Gedung Gereja Utama',	'Pdt. John Doe',	'Maria Susanti',	'Tim Worship A',	'Tim Band A',	'David Chen',	'Tim Usher A',	'Ibadah Minggu Pertama',	'1',	'#007bff',	1,	'2025-12-28 16:04:51'),
(2,	'Ibadah Minggu II',	'Ibadah Minggu',	'2025-12-29',	'10:00:00',	'12:00:00',	'Gedung Gereja Utama',	'Pdt. Jane Smith',	'Robert Tan',	'Tim Worship B',	'Tim Band B',	'Sarah Lee',	'Tim Usher B',	'Ibadah Minggu Kedua',	'1',	'#007bff',	1,	'2025-12-28 16:04:51'),
(3,	'Ibadah Minggu I',	'Ibadah Minggu',	'2026-01-05',	'07:00:00',	'09:00:00',	'Gedung Gereja Utama',	'Pdt. Michael Wong',	'Linda Wijaya',	'Tim Worship C',	'Tim Band C',	'David Chen',	'Tim Usher C',	'Ibadah Minggu Pertama',	'1',	'#007bff',	1,	'2025-12-28 16:04:51'),
(4,	'Ibadah Minggu II',	'Ibadah Minggu',	'2026-01-05',	'10:00:00',	'12:00:00',	'Gedung Gereja Utama',	'Pdt. Sarah Johnson',	'Kevin Lim',	'Tim Worship A',	'Tim Band A',	'Sarah Lee',	'Tim Usher A',	'Ibadah Minggu Kedua',	'1',	'#007bff',	1,	'2025-12-28 16:04:51'),
(5,	'Ibadah Pemuda',	'Ibadah Pemuda',	'2025-12-28',	'18:00:00',	'20:00:00',	'Aula Gereja',	'Pdt. Youth Leader',	'Youth Team',	'Youth Worship Team',	'Youth Band',	'Youth Multimedia',	'Youth Usher',	'Ibadah khusus pemuda',	'1',	'#28a745',	1,	'2025-12-28 16:04:51'),
(6,	'Persekutuan Doa',	'Persekutuan Doa',	'2025-12-25',	'19:00:00',	'21:00:00',	'Ruang Doa',	'Pdt. Prayer Leader',	NULL,	NULL,	NULL,	NULL,	NULL,	'Persekutuan doa rutin',	'1',	'#ffc107',	1,	'2025-12-28 16:04:51'),
(7,	'Sekolah Minggu',	'Ibadah Anak',	'2025-12-29',	'09:00:00',	'11:00:00',	'Ruang Anak',	'Guru Sekolah Minggu',	NULL,	NULL,	NULL,	NULL,	NULL,	'Sekolah Minggu untuk anak-anak',	'1',	'#17a2b8',	1,	'2025-12-28 16:04:51'),
(8,	'Komsel Wilayah A',	'Komsel',	'2025-12-27',	'19:00:00',	'21:00:00',	'Rumah Jemaat A',	'Ketua Komsel A',	NULL,	NULL,	NULL,	NULL,	NULL,	'Komsel wilayah A',	'1',	'#6f42c1',	1,	'2025-12-28 16:04:51'),
(9,	'Komsel Wilayah B',	'Komsel',	'2025-12-27',	'19:00:00',	'21:00:00',	'Rumah Jemaat B',	'Ketua Komsel B',	NULL,	NULL,	NULL,	NULL,	NULL,	'Komsel wilayah B',	'1',	'#6f42c1',	1,	'2025-12-28 16:04:51');

DROP TABLE IF EXISTS `custome__jemaat`;
...
TRUNCATE `custome__jemaat`;
INSERT INTO `custome__jemaat` (`id_jemaat`, `no_anggota`, `nama_lengkap`, `nama_panggilan`, `tempat_lahir`, `tgl_lahir`, `jenis_kelamin`, `alamat_lengkap`, `rt_rw`, `kelurahan`, `kecamatan`, `kota`, `kode_pos`, `no_hp`, `email`, `pekerjaan`, `pendidikan`, `status_pernikahan`, `nama_ayah`, `nama_ibu`, `nama_pasangan`, `tgl_baptis`, `tempat_baptis`, `pendeta_baptis`, `tgl_sidi`, `tempat_sidi`, `pendeta_sidi`, `tgl_nikah`, `tempat_nikah`, `pendeta_nikah`, `status_keanggotaan`, `tgl_bergabung`, `tgl_pindah`, `tgl_meninggal`, `gereja_asal`, `gereja_tujuan`, `keterangan`, `foto`, `created_at`, `updated_at`) VALUES
(1,	'JMT001',	'Budi Santoso',	'Budi',	'Jakarta',	'1980-05-15',	'L',	'Jl. Merdeka No. 123, Jakarta',	NULL,	NULL,	NULL,	NULL,	NULL,	'081234567890',	'budi@email.com',	'Karyawan Swasta',	NULL,	'Belum Menikah',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'Aktif',	'2020-01-01',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'2025-12-28 16:03:37',	'2025-12-28 16:03:37'),
(2,	'JMT002',	'Siti Rahayu',	'Siti',	'Bandung',	'1985-08-20',	'P',	'Jl. Sudirman No. 456, Bandung',	NULL,	NULL,	NULL,	NULL,	NULL,	'081234567891',	'siti@email.com',	'Guru',	NULL,	'Belum Menikah',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'Aktif',	'2020-02-15',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'2025-12-28 16:03:37',	'2025-12-28 16:03:37'),
(3,	'JMT003',	'Ahmad Wijaya',	'Ahmad',	'Surabaya',	'1975-12-10',	'L',	'Jl. Pahlawan No. 789, Surabaya',	NULL,	NULL,	NULL,	NULL,	NULL,	'081234567892',	'ahmad@email.com',	'Wiraswasta',	NULL,	'Belum Menikah',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'Aktif',	'2019-06-01',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'2025-12-28 16:03:37',	'2025-12-28 16:03:37');

DROP TABLE IF EXISTS `custome__jenis_ibadah`;
...
TRUNCATE `custome__jenis_ibadah`;
INSERT INTO `custome__jenis_ibadah` (`id_jenis_ibadah`, `nama_jenis`, `deskripsi`, `warna`, `durasi_menit`, `status`, `created_at`, `updated_at`) VALUES
(1,	'Ibadah Minggu Pagi',	'Ibadah rutin hari Minggu pagi',	'#007bff',	120,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(2,	'Ibadah Minggu Sore',	'Ibadah rutin hari Minggu sore',	'#17a2b8',	90,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(3,	'Ibadah Rabu',	'Ibadah tengah minggu hari Rabu',	'#28a745',	90,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(4,	'Ibadah Jumat',	'Ibadah doa dan pujian hari Jumat',	'#ffc107',	60,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(5,	'Ibadah Natal',	'Ibadah perayaan Natal',	'#dc3545',	150,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
(6,	'Ibadah Paskah',	'Ibadah perayaan Paskah',	'#fd7e14',	150,	'Aktif',	'2025-12-28 16:03:23',	'2025-12-28 16:03:23'),
...
TRUNCATE `custome__kategorilapak`;
INSERT INTO `custome__kategorilapak` (`kategorilapak_id`, `nama_kategori_produk`, `slug_kategori_produk`) VALUES
(1,	'Umum',	'Umum'),
(2,	'Makanan',	'Makanan'),
(3,	'Elektronik',	'Elektronik'),
(4,	'Sovenir',	'Sovenir'),
(5,	'Benda Rohani',	'Benda Rohani'),
(6,	'Kerajinan Tangan',	'Kerajinan Tangan');

DROP TABLE IF EXISTS `custome__kategori_aset`;
...
TRUNCATE `custome__kategori_aset`;
INSERT INTO `custome__kategori_aset` (`id_kategori`, `kode_kategori`, `nama_kategori`, `parent_id`, `deskripsi`, `icon`, `warna`, `masa_pakai`, `metode_depreciation`, `status`, `urutan`, `created_at`, `updated_at`) VALUES
(1,	'FURN',	'Furniture & Perabotan',	NULL,	'Meja, kursi, lemari, dan perabotan lainnya',	'fas fa-chair',	'#8B4513',	10,	'Straight Line',	'Aktif',	1,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(2,	'ELEC',	'Elektronik',	NULL,	'Komputer, TV, sound system, dan peralatan elektronik',	'fas fa-tv',	'#1E90FF',	5,	'Straight Line',	'Aktif',	2,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(3,	'VEHI',	'Kendaraan',	NULL,	'Mobil, motor, dan kendaraan operasional',	'fas fa-car',	'#FF6347',	8,	'Declining Balance',	'Aktif',	3,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(4,	'BUIL',	'Bangunan & Infrastruktur',	NULL,	'Gedung, renovasi, dan infrastruktur',	'fas fa-building',	'#32CD32',	20,	'Straight Line',	'Aktif',	4,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(5,	'COMP',	'Komputer & IT',	2,	'Laptop, PC, printer, dan peralatan IT',	'fas fa-laptop',	'#4169E1',	4,	'Straight Line',	'Aktif',	5,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(6,	'SOUN',	'Sound System',	2,	'Mixer, speaker, microphone, dan peralatan audio',	'fas fa-microphone',	'#FF1493',	7,	'Straight Line',	'Aktif',	6,	'2025-12-28 16:03:08',	'2025-12-28 16:03:08');

DROP TABLE IF EXISTS `custome__kategori_keuangan`;
...
TRUNCATE `custome__kategori_produk`;
INSERT INTO `custome__kategori_produk` (`kategori_id`, `nama_kategori`, `slug_kategori`, `deskripsi`, `gambar`, `urutan`, `status`) VALUES
(1,	'Makanan & Minuman',	'makanan-minuman',	'Produk makanan dan minuman hasil UMKM jemaat',	NULL,	1,	'1'),
(2,	'Kerajinan Tangan',	'kerajinan-tangan',	'Kerajinan tangan dan souvenir',	NULL,	2,	'1'),
(3,	'Pakaian',	'pakaian',	'Pakaian dan aksesoris',	NULL,	3,	'1'),
(4,	'Buku & Literatur',	'buku-literatur',	'Buku rohani dan literatur Kristen',	NULL,	4,	'1'),
(5,	'Lainnya',	'lainnya',	'Produk lainnya',	NULL,	5,	'1');

DROP TABLE IF EXISTS `custome__kecamatan`;
...
TRUNCATE `custome__kecamatan`;
INSERT INTO `custome__kecamatan` (`id_kec`, `nama_kec`) VALUES
(0,	'-'),
(1,	'Kelapa Lima'),
(2,	'Oebobo'),
(3,	'Maulafa'),
...
DROP TABLE IF EXISTS `custome__kehadiran_ibadah`;
...
TRUNCATE `custome__kehadiran_ibadah`;

DROP TABLE IF EXISTS `custome__kelolasampah`;
...
TRUNCATE `custome__kelolasampah`;
INSERT INTO `custome__kelolasampah` (`id_kelolasampah`, `id`, `opd_id`, `tahun`, `bulan`, `kode_thnbulan`, `kertas`, `plastik`, `kaca`, `logam`, `lainnya`, `jumlah_penabung`, `foto_kegiatan`, `sts_kelola`) VALUES
(1,	1,	8,	'2021',	'01',	'Januari20218',	1.00,	2.00,	3.00,	4.00,	5.00,	6,	'1656987603_4858bc05582eda6d6b02.jpg',	'1');

DROP TABLE IF EXISTS `custome__keluarga_jemaat`;
...
TRUNCATE `custome__keluarga_jemaat`;

DROP TABLE IF EXISTS `custome__keranjang`;
...
TRUNCATE `custome__komisi_majelis`;
INSERT INTO `custome__komisi_majelis` (`komisi_id`, `nama_komisi`, `deskripsi`, `ketua_komisi`, `status`, `created_at`) VALUES
(1,	'Komisi Pembangunan',	'Komisi yang menangani pembangunan dan pemeliharaan gedung gereja',	NULL,	'Aktif',	'2025-12-28 16:04:15'),
(2,	'Komisi Diakonia',	'Komisi yang menangani pelayanan sosial dan kemasyarakatan',	NULL,	'Aktif',	'2025-12-28 16:04:15'),
(3,	'Komisi Musik',	'Komisi yang menangani musik dan pujian',	NULL,	'Aktif',	'2025-12-28 16:04:15'),
(4,	'Komisi Pendidikan',	'Komisi yang menangani pendidikan dan pelatihan jemaat',	NULL,	'Aktif',	'2025-12-28 16:04:15'),
(5,	'Komisi Pemuda',	'Komisi yang menangani pelayanan pemuda',	NULL,	'Aktif',	'2025-12-28 16:04:15'),
(6,	'Komisi Wanita',	'Komisi yang menangani pelayanan wanita',	NULL,	'Aktif',	'2025-12-28 16:04:15');

DROP TABLE IF EXISTS `custome__konfigurasi`;
...
TRUNCATE `custome__konfigurasi`;
INSERT INTO `custome__konfigurasi` (`id`, `nama_key`, `nilai`, `deskripsi`, `updated_at`) VALUES
(1,	'whatsapp_admin',	'6281234567890',	'Nomor WhatsApp Admin untuk pembelian produk (format: 62xxx)',	'2025-12-28 16:05:38'),
(2,	'whatsapp_template',	'Halo, saya tertarik dengan produk:\n\n*{nama_produk}*\nHarga: Rp {harga}\n\nApakah produk ini masih tersedia?',	'Template pesan WhatsApp default',	'2025-12-28 16:05:38');

DROP TABLE IF EXISTS `custome__lapak`;
...
TRUNCATE `custome__lapak`;
INSERT INTO `custome__lapak` (`id_lapak`, `id`, `nama_lapak`, `harga`, `stok`, `ket`, `sts`, `cover`, `kategorilapak_id`, `no_wa`) VALUES
...
TRUNCATE `custome__lokasi_aset`;
INSERT INTO `custome__lokasi_aset` (`id_lokasi`, `kode_lokasi`, `nama_lokasi`, `jenis_lokasi`, `parent_id`, `deskripsi`, `kapasitas`, `penanggung_jawab`, `status`, `created_at`, `updated_at`) VALUES
(1,	'GU01',	'Gedung Utama',	'Gedung',	NULL,	'Gedung utama gereja untuk ibadah',	NULL,	'Pak Pendeta',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(2,	'RU01',	'Ruang Ibadah Utama',	'Ruangan',	1,	'Ruang ibadah utama dengan kapasitas 500 orang',	500,	'Tim Liturgi',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(3,	'RU02',	'Ruang Kelas Sekolah Minggu',	'Ruangan',	1,	'Ruang untuk kegiatan sekolah minggu anak-anak',	50,	'Guru SM',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(4,	'RU03',	'Ruang Kantor',	'Ruangan',	1,	'Ruang kantor administrasi gereja',	10,	'Sekretaris',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(5,	'RU04',	'Ruang Konsistori',	'Ruangan',	1,	'Ruang rapat majelis dan konsistori',	20,	'Ketua Majelis',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(6,	'GU02',	'Gedung Serbaguna',	'Gedung',	NULL,	'Gedung untuk acara besar dan kegiatan komunitas',	NULL,	'Koordinator Acara',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(7,	'RU05',	'Dapur',	'Ruangan',	6,	'Dapur untuk persiapan makanan acara',	15,	'Tim Konsumsi',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(8,	'AR01',	'Halaman Parkir',	'Area',	NULL,	'Area parkir kendaraan jemaat',	100,	'Satpam',	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08');

DROP TABLE IF EXISTS `custome__maintenance_aset`;
...
TRUNCATE `custome__maintenance_aset`;
...
TRUNCATE `custome__majelis_gereja`;
INSERT INTO `custome__majelis_gereja` (`majelis_id`, `nama`, `nip`, `tempat_lahir`, `tgl_lahir`, `jk`, `agama`, `alamat`, `no_hp`, `email`, `jabatan_id`, `jenis_jabatan`, `tanggal_penahbisan`, `tanggal_pelantikan`, `tanggal_akhir_jabatan`, `status_jabatan`, `gereja_asal`, `pendidikan_teologi`, `sertifikasi`, `komisi`, `gambar`, `file_sk_pengangkatan`, `file_sertifikat`, `file_foto`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
(1,	'Pendeta Dr. John Doe',	NULL,	'Jakarta',	'1975-03-15',	'Laki-laki',	'Kristen Protestan',	'Jl. Gereja No. 1',	'08123456789',	'john.doe@gereja.org',	6,	'Pendeta',	'2010-05-15',	'2020-01-10',	NULL,	'Aktif',	'Gereja Bethel',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'2025-12-28 16:04:15',	'2025-12-28 16:04:15',	NULL,	NULL),
(2,	'Ibu Mary Smith',	NULL,	'Bandung',	'1980-07-22',	'Perempuan',	'Kristen Protestan',	'Jl. Majelis No. 5',	'08198765432',	'mary.smith@gereja.org',	1,	'Ketua Majelis',	NULL,	'2023-01-15',	NULL,	'Aktif',	'Gereja Immanuel',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	'2025-12-28 16:04:15',	'2025-12-28 16:04:15',	NULL,	NULL);
...
TRUNCATE `custome__majelis_komisi`;
...
TRUNCATE `custome__masa_jabatan_majelis`;
INSERT INTO `custome__masa_jabatan_majelis` (`masa_jabatan_id`, `majelis_id`, `jabatan_id`, `tanggal_mulai`, `tanggal_selesai`, `status`, `keterangan`, `created_at`, `updated_at`) VALUES
(1,	1,	6,	'2020-01-10',	'2025-01-10',	'Aktif',	NULL,	'2025-12-28 16:04:15',	'2025-12-28 16:04:15'),
(2,	2,	1,	'2023-01-15',	'2026-01-15',	'Aktif',	NULL,	'2025-12-28 16:04:15',	'2025-12-28 16:04:15');

DROP TABLE IF EXISTS `custome__masterdata`;
...
DROP TABLE IF EXISTS `custome__master_dokumen_pendaftaran`;
...
TRUNCATE `custome__master_dokumen_pendaftaran`;
INSERT INTO `custome__master_dokumen_pendaftaran` (`master_dokumen_id`, `jenis_pendaftaran`, `nama_dokumen`, `keterangan`, `wajib`, `urutan`, `aktif`) VALUES
(1,	'sidi',	'KTP',	'Kartu Tanda Penduduk',	1,	1,	1),
(2,	'sidi',	'Kartu Keluarga',	'KK',	1,	2,	1),
(3,	'sidi',	'Sertifikat Baptis',	'Surat Baptis dari gereja',	1,	3,	1),
(4,	'sidi',	'Foto',	'Pas foto 3x4',	1,	4,	1),
(5,	'sidi',	'Surat Rekomendasi',	'Dari gereja asal (jika pindahan)',	0,	5,	1),
(6,	'sidi',	'Sertifikat Katekisasi',	'Bukti mengikuti katekisasi',	1,	6,	1),
(7,	'baptis',	'KTP',	'Kartu Tanda Penduduk',	1,	1,	1),
(8,	'baptis',	'Kartu Keluarga',	'KK',	1,	2,	1),
(9,	'baptis',	'Akta Lahir',	'Akta kelahiran',	1,	3,	1),
(10,	'baptis',	'Foto',	'Pas foto 3x4',	1,	4,	1),
(11,	'baptis',	'Surat Nikah Orang Tua',	'Untuk baptis anak',	0,	5,	1),
(12,	'baptis',	'Surat Pernyataan Orang Tua',	'Persetujuan orang tua',	0,	6,	1),
(13,	'baptis',	'Sertifikat Katekisasi',	'Untuk baptis dewasa',	0,	7,	1),
(14,	'nikah',	'KTP Calon Suami',	'KTP calon suami',	1,	1,	1),
(15,	'nikah',	'KTP Calon Istri',	'KTP calon istri',	1,	2,	1),
(16,	'nikah',	'KK Calon Suami',	'Kartu Keluarga calon suami',	1,	3,	1),
(17,	'nikah',	'KK Calon Istri',	'Kartu Keluarga calon istri',	1,	4,	1),
(18,	'nikah',	'Surat Baptis Calon Suami',	'Sertifikat baptis',	1,	5,	1),
(19,	'nikah',	'Surat Baptis Calon Istri',	'Sertifikat baptis',	1,	6,	1),
(20,	'nikah',	'Surat Sidi Calon Suami',	'Sertifikat sidi',	1,	7,	1),
(21,	'nikah',	'Surat Sidi Calon Istri',	'Sertifikat sidi',	1,	8,	1),
(22,	'nikah',	'Surat Keterangan Belum Menikah',	'Dari kelurahan',	1,	9,	1),
(23,	'nikah',	'Surat Izin Orang Tua',	'Jika usia < 21 tahun',	0,	10,	1),
(24,	'nikah',	'Sertifikat Konseling Pranikah',	'Bukti mengikuti konseling',	1,	11,	1),
(25,	'nikah',	'Foto Calon Suami',	'Pas foto 4x6',	1,	12,	1),
(26,	'nikah',	'Foto Calon Istri',	'Pas foto 4x6',	1,	13,	1);

DROP TABLE IF EXISTS `custome__mohoninfo`;
...
TRUNCATE `custome__mohoninfo`;

DROP TABLE IF EXISTS `custome__musik_ibadah`;
...
DROP TABLE IF EXISTS `custome__opdtipe`;
...
DROP TABLE IF EXISTS `custome__pelayan_ibadah`;
...
TRUNCATE `custome__pelayan_ibadah`;
...
TRUNCATE `custome__penahbisan_majelis`;

DROP TABLE IF EXISTS `custome__pendaftaran_baptis`;
...
TRUNCATE `custome__pendaftaran_baptis`;
INSERT INTO `custome__pendaftaran_baptis` (`id_baptis`, `nama_lengkap`, `tempat_lahir`, `tgl_lahir`, `jenis_kelamin`, `alamat`, `no_hp`, `email`, `nama_ayah`, `nama_ibu`, `jenis_baptis`, `nama_pendamping`, `hubungan_pendamping`, `tgl_daftar`, `tgl_baptis`, `status`, `keterangan`, `dok_ktp`, `dok_kk`, `dok_akta_lahir`, `dok_foto`, `dok_surat_nikah_ortu`, `kelengkapan_dokumen`, `tgl_disetujui`, `tgl_ditolak`, `approved_by`, `alasan_tolak`, `catatan_admin`) VALUES
(1,	'Baby Smith',	'Bandung',	'2024-03-20',	'Perempuan',	'Jl. Sample No. 456, Bandung',	'082345678901',	'parent.smith@email.com',	'Mr. Smith',	'Mrs. Smith',	'Baptis Anak',	'Mr. Smith',	'Orang Tua',	'2025-01-15',	NULL,	'0',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	NULL,	NULL,	NULL,	NULL,	NULL);

DROP TABLE IF EXISTS `custome__pendaftaran_catatan`;
...
TRUNCATE `custome__pendaftaran_catatan`;

DROP TABLE IF EXISTS `custome__pendaftaran_dokumen`;
...
TRUNCATE `custome__pendaftaran_dokumen`;

DROP TABLE IF EXISTS `custome__pendaftaran_nikah`;
...
TRUNCATE `custome__pendaftaran_nikah`;
INSERT INTO `custome__pendaftaran_nikah` (`id_nikah`, `nama_pria`, `tempat_lahir_pria`, `tgl_lahir_pria`, `alamat_pria`, `no_hp_pria`, `email_pria`, `pekerjaan_pria`, `status_baptis_pria`, `gereja_baptis_pria`, `nama_ayah_pria`, `nama_ibu_pria`, `nama_wanita`, `tempat_lahir_wanita`, `tgl_lahir_wanita`, `alamat_wanita`, `no_hp_wanita`, `email_wanita`, `pekerjaan_wanita`, `status_baptis_wanita`, `gereja_baptis_wanita`, `nama_ayah_wanita`, `nama_ibu_wanita`, `tgl_daftar`, `tgl_nikah_diinginkan`, `tempat_nikah`, `status`, `keterangan`, `dok_ktp_pria`, `dok_kk_pria`, `dok_baptis_pria`, `dok_sidi_pria`, `dok_foto_pria`, `dok_ktp_wanita`, `dok_kk_wanita`, `dok_baptis_wanita`, `dok_sidi_wanita`, `dok_foto_wanita`, `dok_surat_izin_ortu`, `dok_surat_keterangan_gereja`, `kelengkapan_dokumen`, `tgl_disetujui`, `tgl_ditolak`, `approved_by`, `alasan_tolak`, `catatan_admin`) VALUES
(1,	'Michael Anderson',	'Surabaya',	'1995-08-10',	'Jl. Merdeka No. 789, Surabaya',	'083456789012',	'michael.a@email.com',	'Karyawan Swasta',	'Sudah',	'GKI Surabaya',	'Bapak Anderson',	'Ibu Anderson',	'Sarah Johnson',	'Surabaya',	'1997-11-25',	'Jl. Pemuda No. 321, Surabaya',	'084567890123',	'sarah.j@email.com',	'Guru',	'Sudah',	'GKI Surabaya',	'Bapak Johnson',	'Ibu Johnson',	'2025-01-15',	'2025-06-15',	'GKI Surabaya',	'0',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	NULL,	NULL,	NULL,	NULL,	NULL);

DROP TABLE IF EXISTS `custome__pendaftaran_sidi`;
...
TRUNCATE `custome__pendaftaran_sidi`;
INSERT INTO `custome__pendaftaran_sidi` (`id_sidi`, `nama_lengkap`, `tempat_lahir`, `tgl_lahir`, `jenis_kelamin`, `alamat`, `no_hp`, `email`, `nama_ayah`, `nama_ibu`, `tgl_baptis`, `gereja_baptis`, `tgl_daftar`, `tgl_sidi`, `status`, `keterangan`, `dok_ktp`, `dok_kk`, `dok_baptis`, `dok_foto`, `kelengkapan_dokumen`, `tgl_disetujui`, `tgl_ditolak`, `approved_by`, `alasan_tolak`, `catatan_admin`) VALUES
(1,	'John Doe',	'Jakarta',	'2005-05-15',	'Laki-laki',	'Jl. Contoh No. 123, Jakarta',	'081234567890',	'john.doe@email.com',	'Bapak John',	'Ibu Jane',	'2010-12-25',	'GPIB Immanuel Jakarta',	'2025-01-15',	NULL,	'0',	NULL,	NULL,	NULL,	NULL,	NULL,	0,	NULL,	NULL,	NULL,	NULL,	NULL);

DROP TABLE IF EXISTS `custome__pendaftaran_timeline`;
...
TRUNCATE `custome__pendaftaran_timeline`;

DROP TABLE IF EXISTS `custome__pengumuman_ibadah`;
...
TRUNCATE `custome__pengumuman_ibadah`;

DROP TABLE IF EXISTS `custome__perbaikan_aset`;
...
TRUNCATE `custome__perbaikan_aset`;

DROP TABLE IF EXISTS `custome__persembahan_ibadah`;
...
TRUNCATE `custome__persembahan_ibadah`;
...
TRUNCATE `custome__pesanan_detail`;
...
TRUNCATE `custome__pesanan_tracking`;

DROP TABLE IF EXISTS `custome__produk_umkm`;
...
TRUNCATE `custome__produk_umkm`;
INSERT INTO `custome__produk_umkm` (`id_produk`, `nama_produk`, `slug_produk`, `kategori_id`, `deskripsi`, `harga`, `harga_promo`, `stok`, `berat`, `satuan`, `gambar`, `galeri`, `status`, `featured`, `hits`, `whatsapp_clicks`, `tgl_input`, `user_id`, `whatsapp_admin`, `whatsapp_template`) VALUES
(1,	'Kue Kering Natal',	'kue-kering-natal',	1,	'Kue kering spesial Natal dengan berbagai varian rasa',	75000.00,	65000.00,	50,	500,	'box',	NULL,	NULL,	'1',	'1',	2,	0,	'2025-12-28 16:05:15',	1,	NULL,	NULL),
...
TRUNCATE `custome__riwayat_pelayanan`;

DROP TABLE IF EXISTS `custome__transaksi_keuangan`;
...
TRUNCATE `custome__transfer_aset`;

DROP TABLE IF EXISTS `custome__vendor_maintenance`;
...
TRUNCATE `custome__vendor_maintenance`;
INSERT INTO `custome__vendor_maintenance` (`id_vendor`, `kode_vendor`, `nama_vendor`, `jenis_vendor`, `alamat`, `telepon`, `email`, `contact_person`, `spesialisasi`, `rating`, `status`, `created_at`, `updated_at`) VALUES
(1,	'VEN001',	'CV Mitra Elektronik',	'Supplier',	'Jl. Elektronik No. 123, Jakarta',	'021-1234567',	'info@mitraelektronik.com',	'Budi Santoso',	'Peralatan elektronik, sound system, komputer',	4.5,	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(2,	'VEN002',	'Bengkel Jaya Motor',	'Maintenance',	'Jl. Raya Motor No. 456, Jakarta',	'021-7654321',	'jayamotor@gmail.com',	'Ahmad Wijaya',	'Service kendaraan bermotor',	4.2,	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(3,	'VEN003',	'Furniture Indah',	'Supplier',	'Jl. Furniture No. 789, Jakarta',	'021-9876543',	'furniture.indah@yahoo.com',	'Siti Nurhaliza',	'Furniture kantor dan rumah tangga',	4.0,	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(4,	'VEN004',	'IT Solution Pro',	'Maintenance',	'Jl. IT Center No. 321, Jakarta',	'021-5555666',	'support@itsolutionpro.com',	'Dedi Kurniawan',	'Maintenance komputer, jaringan, software',	4.7,	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08'),
(5,	'VEN005',	'Asuransi Berkah',	'Insurance',	'Jl. Asuransi No. 654, Jakarta',	'021-7777888',	'info@asuransiberkah.co.id',	'Maya Sari',	'Asuransi kendaraan dan properti',	4.3,	'Aktif',	'2025-12-28 16:03:08',	'2025-12-28 16:03:08');
...
(8,	1,	'Ebook Author',	'1639400811_8036ce709ce1978cbe3d.png',	'1639400811_c09db5abd955a1bf3bc5.pdf',	'ikasmedia     ',	'233',	'2021-12-13',	27,	'1',	14);

DROP TABLE IF EXISTS `faq_jawab`;
...
DROP TABLE IF EXISTS `faq_tanya`;
...
DROP TABLE IF EXISTS `kategori_ebook`;
...
TRUNCATE `kritiksaran`;
INSERT INTO `kritiksaran` (`kritiksaran_id`, `nama`, `email`, `judul`, `isi_kritik`, `tanggal`, `status`, `no_hpusr`, `balas`, `tgl_bls`) VALUES
(1,	'ikasmedia',	'ikasmedia@gmail.com',	'Permintaan Informasi',	'Kapan akan dilakukan asistensi untuk semua perangkat desa?',	'2022-07-21',	1,	'6281353967028',	'Tangal 17 Agustus mendatang pak',	'2025-03-08'),
...
DROP TABLE IF EXISTS `modalpopup`;
...
(69,	'1929411',	'ikasmedia',	'Bukit',	'1985-03-22',	'L',	'Katolik',	'III D',	'Staf',	'default.png',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
...
DROP TABLE IF EXISTS `produk_subkathukum`;
...
DROP TABLE IF EXISTS `survey_responden`;
...
DROP TABLE IF EXISTS `survey_topik`;
...
DROP TABLE IF EXISTS `tbl_setaplikasi`;
...
DROP TABLE IF EXISTS `transparan`;
...
DROP TABLE IF EXISTS `transparan_detail`;
