-- =====================================================
-- Database Schema: Modul Inventaris Gereja
...
('RU05', 'Dapur', 'Ruangan', 2, 'Dapur untuk persiapan makanan acara', 15, 'Tim Konsumsi', 'Aktif'),
...
-- Sample Aset Gereja
INSERT INTO `custome__aset_gereja` (`kode_aset`, `nama_aset`, `id_kategori`, `id_lokasi`, `merk`, `model`, `serial_number`, `tahun_pembuatan`, `tanggal_pembelian`, `harga_perolehan`, `nilai_residu`, `masa_pakai`, `supplier`, `no_faktur`, `warranty_start`, `warranty_end`, `kondisi`, `status`, `spesifikasi`, `keterangan`, `created_by`) VALUES
('AST001', 'Kursi Jemaat Kayu Jati', 1, 2, 'Furniture Indah', 'FI-KJ-001', 'FI001-100', 2024, '2024-01-15', 15000000.00, 1500000.00, 10, 'Furniture Indah', 'INV-2024-001', '2024-01-15', '2025-01-15', 'Baik', 'Aktif', '100 unit kursi kayu jati dengan bantalan', 'Kursi untuk jemaat di ruang ibadah utama', 1),
('AST002', 'Sound System Yamaha', 6, 2, 'Yamaha', 'MG16XU', 'YMH-2024-001', 2024, '2024-02-10', 25000000.00, 2500000.00, 7, 'CV Mitra Elektronik', 'INV-2024-002', '2024-02-10', '2026-02-10', 'Baik', 'Aktif', 'Mixer 16 channel dengan USB interface', 'Sound system utama untuk ibadah', 1),
('AST003', 'Laptop Dell Inspiron', 5, 4, 'Dell', 'Inspiron 15 3000', 'DL123456789', 2024, '2024-03-05', 8500000.00, 850000.00, 4, 'CV Mitra Elektronik', 'INV-2024-003', '2024-03-05', '2025-03-05', 'Baik', 'Aktif', 'Intel i5, 8GB RAM, 512GB SSD', 'Laptop untuk administrasi kantor', 1),
('AST004', 'Meja Kantor Minimalis', 1, 4, 'Furniture Indah', 'FI-MK-002', 'FI002-005', 2024, '2024-01-20', 3500000.00, 350000.00, 10, 'Furniture Indah', 'INV-2024-004', '2024-01-20', '2025-01-20', 'Baik', 'Aktif', '5 unit meja kantor dengan laci', 'Meja untuk staff administrasi', 1),
('AST005', 'Proyektor Epson', 2, 2, 'Epson', 'EB-X41', 'EPS-2024-001', 2024, '2024-04-12', 6500000.00, 650000.00, 5, 'CV Mitra Elektronik', 'INV-2024-005', '2024-04-12', '2025-04-12', 'Baik', 'Aktif', '3600 lumens, XGA resolution', 'Proyektor untuk presentasi ibadah', 1);
